...
public class DefaultContainerAssociationApproximations implements
	...
	private static final String[] APPROXIMATIONS =
		{
				"ptidej.solver.java.constraint.repository.ContainerCompositionConstraint",
				"ptidej.solver.java.constraint.repository.ContainerAggregationConstraint",
				"ptidej.solver.java.constraint.repository.CompositionConstraint",
				"ptidej.solver.java.constraint.repository.AggregationConstraint",
