...
import ptidej.solver.java.constraint.AbstractRelationshipConstraint;
 ...
 */
public class CompositionConstraint extends AbstractRelationshipConstraint {
	public CompositionConstraint(
		final String name,
		...
		this.setSymbol("[#]->");
		this.setStrict(true);
		this.setFieldName("composedEntities");
	}
}
