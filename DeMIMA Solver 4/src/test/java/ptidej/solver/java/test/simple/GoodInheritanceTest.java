...
public final class GoodInheritanceTest extends Primitive {
	...
	protected void setUp() {
		if (GoodInheritanceTest.BuiltSolutions == null) {
			GoodInheritanceTest.BuiltSolutions =
	...
	public void testSolution12() {
		Assert.assertEquals(
			"F -|>- java.lang.Object",
			"java.lang.Object",
			GoodInheritanceTest.BuiltSolutions[11].getComponent(
	...
	public void testSolution13() {
		Assert.assertEquals(
			...
			"java.lang.Object",
			GoodInheritanceTest.BuiltSolutions[12].getComponent(
				InheritanceProblem.SUPER_ENTITY).getDisplayValue());
		Assert.assertEquals(
			"java.lang.Object == java.lang.Object",
			"java.lang.Object",
	...
	public void testSolution2() {
		Assert.assertEquals(
			"A -|>- java.lang.Object",
			"java.lang.Object",
			GoodInheritanceTest.BuiltSolutions[1].getComponent(
				InheritanceProblem.SUPER_ENTITY).getDisplayValue());
		Assert.assertEquals(
			"A -|>- java.lang.Object",
			"A",
	...
	public void testSolution3() {
		Assert.assertEquals("B -|>- A", "A", GoodInheritanceTest.BuiltSolutions[2]
			.getComponent(InheritanceProblem.SUPER_ENTITY)
			.getDisplayValue());
	...
	public void testSolution5() {
		Assert.assertEquals("C -|>- B", "B", GoodInheritanceTest.BuiltSolutions[4]
			.getComponent(InheritanceProblem.SUPER_ENTITY)
			.getDisplayValue());
	...
	public void testSolution8() {
		Assert.assertEquals(
			"D -|>- java.lang.Object",
			"java.lang.Object",
			GoodInheritanceTest.BuiltSolutions[7].getComponent(
				InheritanceProblem.SUPER_ENTITY).getDisplayValue());
		Assert.assertEquals(
			"D -|>- java.lang.Object",
			"D",
	...
	public void testSolution9() {
		Assert.assertEquals("E -|>- D", "D", GoodInheritanceTest.BuiltSolutions[8]
			.getComponent(InheritanceProblem.SUPER_ENTITY)
			.getDisplayValue());
