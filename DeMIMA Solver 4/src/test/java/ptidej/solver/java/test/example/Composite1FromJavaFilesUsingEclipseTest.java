...
public class Composite1FromJavaFilesUsingEclipseTest extends TestCase {
	...
	public Composite1FromJavaFilesUsingEclipseTest(final String name) {
		super(name);
	}
	protected void setUp()
			throws IllegalAccessException, InstantiationException {

		if (Composite1FromJavaFilesUsingEclipseTest.FoundSolutions == null) {
			try {
				...
				// Expected solutions.
				Composite1FromJavaFilesUsingEclipseTest.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite1", idiomLevelModel);
				Composite1FromJavaFilesUsingEclipseTest.NumberOfExpectedSolutions =
				...
				Composite1FromJavaFilesUsingEclipseTest.FoundSolutions =
	...
	public void testNumberOfSolutions() {
		Assert.assertEquals(
			"Number of solutions",
			Composite1FromJavaFilesUsingEclipseTest.NumberOfExpectedSolutions,
			Composite1FromJavaFilesUsingEclipseTest.FoundSolutions.length);
	}
	public void testSolutions() {
		for (int i =
			0; i < Composite1FromJavaFilesUsingEclipseTest.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals(
				"",
				Composite1FromJavaFilesUsingEclipseTest.ExpectedSolutions[i],
				Composite1FromJavaFilesUsingEclipseTest.FoundSolutions[i]);
		}
	}
}
