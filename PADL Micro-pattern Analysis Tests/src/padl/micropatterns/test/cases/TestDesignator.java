			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
								"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/Designator.class",
								"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/Designator2.class", }));
			}
			catch (Exception e) {
