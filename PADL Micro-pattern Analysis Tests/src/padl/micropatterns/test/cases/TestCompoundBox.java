			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
								"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/CompoundBox.class",
								"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/NonPrimitive.class", }));
			}
			catch (Exception e) {
