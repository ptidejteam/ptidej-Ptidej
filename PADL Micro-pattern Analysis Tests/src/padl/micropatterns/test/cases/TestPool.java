			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
						//"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/IPoolMother.class",
						//"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/IPoolSon.class",
						"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/PoolMotherClass.class",
						//"../PADL Micro-pattern Analysis Tests/bin/padl/micropatterns/examples/PoolSonClass.class",
						}));
			}
			catch (Exception e) {
