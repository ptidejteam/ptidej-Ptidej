...
public class CpointTest extends CppPrimitive {
	...
	protected void setUp() {
		if (CpointTest.FirstClassEntities == null
			...
			CpointTest.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(codeLevelModel);

			// All the element of the first class
			CpointTest.Elements = Util
					.getArrayOfElements(CpointTest.FirstClassEntities[0]);
		}
	}

	public void testClass() {
		//---------------------------------------
		Assert.assertEquals("Class name", "CPoint",
	...
	public void testClassCpointConstructor() {
		//---------------------------------------
		Assert.assertEquals("Constr Name", "CPoint",
		...
		//---------------------------------------
		Assert.assertEquals("Constr Name", "afficher",
	...
	public void testClassCpointMethod() {
		...
		//---------------------------------------
		Assert.assertEquals("Method Name", "calculer_origine",
		...
		//---------------------------------------
		Assert.assertEquals("Method Name", "lire_x",
		...
		//---------------------------------------
		Assert.assertEquals("Method Name", "lire_y",
	...
	public void testClassCpointField() {
		...
		//---------------------------------------
		Assert.assertEquals("Field Name", "m_x",
				CpointTest.Elements[8].getDisplayName());

		Assert.assertEquals("Field Type", "double",
		...
		//---------------------------------------
		Assert.assertEquals("Field Name", "m_y",
