...
public class InheritanceTest extends CppPrimitive {
	...
	protected void setUp() {
		...
		if (InheritanceTest.FirstClassEntities == null
			...
			// All the entities
			InheritanceTest.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(codeLevelModel);

			// All the element of the first class
			InheritanceTest.Elements1 = Util
					.getArrayOfElements(InheritanceTest.FirstClassEntities[0]);

			// All the element of the second class
			InheritanceTest.Elements2 = Util
					.getArrayOfElements(InheritanceTest.FirstClassEntities[1]);

			// All the element of the third class
			InheritanceTest.Elements3 = Util
					.getArrayOfElements(InheritanceTest.FirstClassEntities[2]);
			//
	...
	public void testClass() {
		//---------------------------------------
		Assert.assertEquals("Class Name", "Forme",
				((IClass) InheritanceTest.FirstClassEntities[0])
						.getDisplayName());

		Assert.assertEquals("Class acces", Access.ACC_PUBLIC,
				((IClass) InheritanceTest.FirstClassEntities[0])
						.getVisibility());

		//---------------------------------------
		Assert.assertEquals("Class Name", "Forme1",
				((IClass) InheritanceTest.FirstClassEntities[1])
						.getDisplayName());
		...
		//---------------------------------------
		Assert.assertEquals("Class Name", "Rectangle",
				((IClass) InheritanceTest.FirstClassEntities[3])
						.getDisplayName());
	...
	public void testGhost() {
		//---------------------------------------
		Assert.assertEquals("Ghost Name", "Forme2",
				((IGhost) InheritanceTest.FirstClassEntities[2])
						.getDisplayName());
	...
	public void testInheritedEntities() {
		//---------------------------------------
		Assert.assertEquals("Inherited Forme Entities", false,
				InheritanceTest.FirstClassEntities[0]
						.getIteratorOnInheritedEntities().hasNext());

		//---------------------------------------
		Assert.assertEquals("Inherited Forme1 Entities", false,
				InheritanceTest.FirstClassEntities[1]
						.getIteratorOnInheritedEntities().hasNext());

		//---------------------------------------
		Assert.assertEquals("Inherited Forme2 Entities", false,
				InheritanceTest.FirstClassEntities[2]
						.getIteratorOnInheritedEntities().hasNext());

		//---------------------------------------
		//Rectangle extends Forme et Forme2
		final Iterator iterator = InheritanceTest.FirstClassEntities[3]
				.getIteratorOnInheritedEntities();
		Assert.assertEquals("Inherited Rectangle Entities",
				InheritanceTest.FirstClassEntities[0], iterator.next());
		Assert.assertEquals("Inherited Rectangle Entities",
				InheritanceTest.FirstClassEntities[2], iterator.next());
		nonEmptyList.clear();
	}
	...
	public void testInheritingEntities() {
		...
		Assert.assertEquals("Inheriting Forme Entities", true,
				InheritanceTest.FirstClassEntities[0]
						.getIteratorOnInheritingEntities().hasNext());
		nonEmptyList.clear();

		//---------------------------------------
		Assert.assertEquals("Inheriting Forme1 Entities", false,
				InheritanceTest.FirstClassEntities[1]
						.getIteratorOnInheritingEntities().hasNext());
		...
		nonEmptyList.add(InheritanceTest.FirstClassEntities[3]);
		Assert.assertEquals("Inheriting Forme2 Entities", true,
				InheritanceTest.FirstClassEntities[2]
						.getIteratorOnInheritingEntities().hasNext());
		nonEmptyList.clear();

		//---------------------------------------
		Assert.assertEquals("Inheriting Rectangle Entities", false,
