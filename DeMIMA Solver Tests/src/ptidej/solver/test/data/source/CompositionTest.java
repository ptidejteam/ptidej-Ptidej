...
public final class CompositionTest extends TestAbstractLevelModel {
	...
	public CompositionTest() {
		...
		final IClass anAggregatedClass1 =
			this.getFactory().createClass(
				...
				"AggregatedClass1".toCharArray());
		final IComposition anComposition1 =
			this.getFactory().createCompositionRelationship(
				"composition".toCharArray(),
				anAggregatedClass1,
				1);
		...
		final IComposition anComposition2 =
			this.getFactory().createCompositionRelationship(
				"composition".toCharArray(),
				anAggregatedClass2,
				1);
		...
		final IPackage enclosingPackage =
			this.getFactory().createPackage("CompositionTest".toCharArray());
