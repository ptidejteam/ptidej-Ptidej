 ...
 * @since  2004/09/05 
 */
public final class CompositionTest4 {
	...
	public static Problem getProblem(final List allEntities) {
		...
		final Variable aggregate =
			new Variable(pb, CompositionTest4.AGGREGATE, true, allEntities);
		final Variable aggregated =
			new Variable(pb, CompositionTest4.AGGREGATED, true, allEntities);
