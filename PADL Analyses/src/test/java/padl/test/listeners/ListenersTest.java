...
public class ListenersTest extends TestCase {
	...
	public ListenersTest(final String name) {
		super(name);
	}

	protected void setUp() throws Exception {
		if (ListenersTest.IdiomLevelModel == null) {
			try {
				...
				ListenersTest.IdiomLevelModel = (IIdiomLevelModel) new AACRelationshipsAnalysis()
	...
	public void testAddListenerModel() throws NoSuchFieldException,
		...
		ListenersTest.IdiomLevelModel.addModelListener(new ModelStatistics());

		final IFirstClassEntity anA = ListenersTest.IdiomLevelModel
