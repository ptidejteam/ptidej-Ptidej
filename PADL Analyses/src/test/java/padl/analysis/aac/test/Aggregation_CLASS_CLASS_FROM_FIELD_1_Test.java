 ...
 * @since	2005/08/08
 */
public class Aggregation_CLASS_CLASS_FROM_FIELD_1_Test extends TestCase {
	...
	public Aggregation_CLASS_CLASS_FROM_FIELD_1_Test(final String name) {
		super(name);
	}

	protected void setUp() {
		if (Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.FirstClassEntities == null
				|| Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements == null) {
			...
			try {
				...
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.FirstClassEntities = Util
						.getArrayOfTopLevelEntities(idiomLevelModel);

				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements = Util
						.getArrayOfElements(
								Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.FirstClassEntities[2]);
			}
	...
	public void testUseRelationship2() {
		Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.assertAssigable(
				"Aggregation link type", IUseRelationship.class,
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[6].getClass());
	...
	public void testAssociation() {
		Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.assertAssigable(
				...
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[1].getClass());
	...
	public void testConstructor() {
		Assert.assertEquals("Constructor",
				...
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[0]
						.getDisplayName());
	}
	...
	public void testFooAssociation() {
		Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.assertAssigable(
				"Association link type", IAssociation.class,
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[7].getClass());
		Assert.assertEquals("Association link visibility",
				Modifier.toString(Modifier.PUBLIC | Modifier.STATIC),
				Modifier.toString(
	...
	public void testUseRelationship() {
		Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.assertAssigable(
				...
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[4].getClass());
	...
	public void testMethodAndMethodInvocations() {
		final IMethod foo = (IMethod) Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[3];
	...
	public void testNumberOfElements() {
		Assert.assertEquals("Number of elements", 8,
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements.length);
	}

	public void testNumberOfEntities() {
		Assert.assertEquals("Number of entities", 3,
				Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.FirstClassEntities.length);
	}
	...
	public void testStaticField() {
		Assert.assertEquals("Static field visibility",
				...
				Modifier.toString(
						Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[2]
								.getVisibility()));
		Assert.assertEquals("Static field type", "padl.analysis.aac.data.A",
				((IField) Aggregation_CLASS_CLASS_FROM_FIELD_1_Test.Elements[2])
						.getDisplayTypeName());
