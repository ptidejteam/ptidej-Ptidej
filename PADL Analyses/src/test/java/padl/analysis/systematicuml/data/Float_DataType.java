...
public final class Float_DataType extends Number implements Comparable {
     ...
     *               parsable number.  
     */
    public static Float_DataType valueOf(String s) throws NumberFormatException {
     ...
     */
    public Float_DataType(float value) {
	this.value = value;
    }
     ...
     * @param   value   the value to be represented by the <code>Float</code>.
     */
    public Float_DataType(double value) {
     ...
     */
    public Float_DataType(String s) throws NumberFormatException {
	...
	return (obj instanceof Float_DataType)
	       && (floatToIntBits(((Float_DataType)obj).value) == floatToIntBits(this.value));
    }
     ...
     */
    public int compareTo(Float_DataType anotherFloat) {
	...
	return compareTo((Float_DataType)o);
    }
    ...
    public static int compare(float f1, float f2) {
       if (f1 < f2)
        ...
        int thisBits = Float_DataType.floatToIntBits(f1);
        int anotherBits = Float_DataType.floatToIntBits(f2);
