...
public class Test1 extends TestCase {
	...
	protected void setUp() {
		if (Test1.ResultingAbstractModel == null) {
			Test1.OriginalCodeLevelModel = Factory.getInstance().createCodeLevelModel("SystematicUML Test 1");
			try {
				Test1.OriginalCodeLevelModel.create(new CompleteClassFileCreator(
						new String[] { "target/test-classes/padl/analysis/systematicuml/data/" }));
				Test1.OriginalIdiomLevelModel = (IIdiomLevelModel) new AACRelationshipsAnalysis()
						.invoke(Test1.OriginalCodeLevelModel);
				Test1.ResultingAbstractModel = new SystematicUMLAnalysis().invoke(Test1.OriginalIdiomLevelModel);
	...
	public void testNumberOfEntities() {
		Assert.assertEquals("Number of entities", Test1.OriginalCodeLevelModel.getNumberOfTopLevelEntities(),
				Test1.ResultingAbstractModel.getNumberOfTopLevelEntities());
	}

	public void testEnumeration() {
		Assert.assertEquals("ClassH_Enumeration", "<<enumeration>>\nClassH_Enumeration", Test1.ResultingAbstractModel
