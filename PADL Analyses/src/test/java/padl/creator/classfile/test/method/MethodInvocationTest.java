...
public class MethodInvocationTest extends TestCase {
	...
	public void setUp() throws Exception {
		if (MethodInvocationTest.CodeLevelModel == null) {
			MethodInvocationTest.CodeLevelModel = Factory.getInstance()
					.createCodeLevelModel("");
			MethodInvocationTest.CodeLevelModel
	...
	public void testMethodInvocation1() {
		Assert.assertEquals("Number of entities", 2,
				MethodInvocationTest.CodeLevelModel.getNumberOfConstituents());
	}

	public void testMethodInvocation2() {
		final IClass clazz = (IClass) MethodInvocationTest.CodeLevelModel
