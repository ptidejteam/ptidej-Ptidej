...
public class Composite1Test extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (Composite1Test.FirstClassEntities == null) {
			...
			Composite1Test.FirstClassEntities =
	...
	public void testNumberOfEntities() {
		Assert.assertEquals(
			"Number of entities",
			11,
			Composite1Test.FirstClassEntities.length);
	}
	public void testDocument() {
		final IClass document = (IClass) Composite1Test.FirstClassEntities[5];
		Assert.assertEquals(
			"Document name",
	...
	public void testIndentedParagraph() {
		final IClass indentedParagraph =
			(IClass) Composite1Test.FirstClassEntities[7];
		Assert.assertEquals(
	...
	public void testMain() {
		final IClass main = (IClass) Composite1Test.FirstClassEntities[8];
		Assert.assertEquals(
			"Main name",
	...
	public void testParagraph() {
		final IClass paragraph = (IClass) Composite1Test.FirstClassEntities[9];
		Assert.assertEquals(
			"Paragraph name",
			"padl.example.composite1.Paragraph",
	...
	public void testTitle() {
		final IClass title = (IClass) Composite1Test.FirstClassEntities[10];
		Assert.assertEquals(
			"Title name",
	...
	public void testAbstractDocument() {
		final IInterface abstractDocument =
			(IInterface) Composite1Test.FirstClassEntities[4];
		Assert.assertEquals(
	...
	public void testElement() {
		final IInterface element =
			(IInterface) Composite1Test.FirstClassEntities[6];
		Assert.assertEquals(
			"Element name",
			"padl.example.composite1.Element",
	...
	public void testGhosts() {
		Assert.assertEquals(
			"java.lang.Object",
			"java.lang.Object",
			Composite1Test.FirstClassEntities[0].getDisplayID());
		Assert.assertEquals(
			"java.util.Vector",
			"java.util.Vector",
			Composite1Test.FirstClassEntities[3].getDisplayID());
		Assert.assertEquals(
			"java.util.Enumeration",
			"java.util.Enumeration",
			Composite1Test.FirstClassEntities[2].getDisplayID());
		Assert.assertEquals(
			"java.lang.String",
			"java.lang.String",
			Composite1Test.FirstClassEntities[1].getDisplayID());
	}
}
