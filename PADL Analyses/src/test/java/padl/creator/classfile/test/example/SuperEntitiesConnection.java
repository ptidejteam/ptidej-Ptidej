...
public class SuperEntitiesConnection extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (SuperEntitiesConnection.FirstClassEntities == null) {
			...
			SuperEntitiesConnection.FirstClassEntities = Util
	...
	public void testDocument() {
		...
		final Object object = ((IClass) SuperEntitiesConnection.FirstClassEntities[5])
	...
	public void testIndentedParagraph() {
		...
		final Iterator iterator = ((IClass) SuperEntitiesConnection.FirstClassEntities[7])
	...
	public void testMain() {
		...
		final Iterator iterator = ((IClass) SuperEntitiesConnection.FirstClassEntities[8])
				.getIteratorOnInheritedEntities();
	...
	public void testParagraph() {
		...
		Iterator iterator = ((IClass) SuperEntitiesConnection.FirstClassEntities[9])
				.getIteratorOnInheritedEntities();
	...
	public void testTitle() {
		...
		Iterator iterator = ((IClass) SuperEntitiesConnection.FirstClassEntities[10])
				.getIteratorOnInheritedEntities();
