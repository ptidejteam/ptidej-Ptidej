...
public class Relationships extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (Relationships.FirstClassEntities == null) {
			...
			Relationships.FirstClassEntities = Util
	...
	public void testCreationLink_INSTANCE_CREATION_2() {
		int index;
		for (index = 0; !Relationships.FirstClassEntities[index].getDisplayID()
				.equals("padl.example.relationship.CreationLink_INSTANCE_CREATION_2"); index++)
			;
		final IElement[] elements = Util
				.getArrayOfElements(Relationships.FirstClassEntities[index]);
	...
	public void testEntity1() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[9];
	...
	public void testEntity3() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[11];
	...
	public void testEntity4() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[12];
	...
	public void testEntity5() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[13];
	...
	public void testEntity6() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[14];
	...
	public void testEntity7() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[15];
	...
	public void testEntity8() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[16];
	...
	public void testEntity9() {
		final IFirstClassEntity entity = Relationships.FirstClassEntities[17];
	...
	public void testJavaLangObject() {
		...
		Assert.assertEquals("Identified elements", 2,
				Relationships.FirstClassEntities[index]
