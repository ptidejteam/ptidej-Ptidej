...
public class Composite1Test extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (Composite1Test.AbstractLevelModel == null) {
			...
			Composite1Test.AbstractLevelModel = (IIdiomLevelModel) new AACRelationshipsAnalysis()
	...
	public void testVisitor() {
		try {
			...
			Composite1Test.AbstractLevelModel.generate(generator);
			...
			*/
			...
			final LineNumberReader reader = new LineNumberReader(
					ProxyDisk.getInstance().fileAbsoluteInput(
							Composite1Test.EXPECTED_FILE_PATH_TST));
