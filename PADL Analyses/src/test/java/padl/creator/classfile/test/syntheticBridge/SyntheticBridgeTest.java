...
public class SyntheticBridgeTest extends TestCase {
	...
	protected void setUp()
		...
		codeLevelModel.create(new CompleteClassFileCreator(new String[] {
				"../PADL Analyses/target/test-classes/padl/example/syntheticBridge/NonGenericImplementation.class",
				"../PADL Analyses/target/test-classes/padl/example/syntheticBridge/PublicSubClass.class" }));
		...
		SyntheticBridgeTest.ElementsNonGenericImpl = Util
				.getArrayOfElements(firstClassEntities[3]);
		SyntheticBridgeTest.ElementsPublicSubClass = Util
	...
	public void testNonGenericImpl() {
		Assert.assertEquals("Number of elements", 4,
				SyntheticBridgeTest.ElementsNonGenericImpl.length);
	}

	public void testPublicSubClass() {
		Assert.assertEquals("Number of elements", 2,
				SyntheticBridgeTest.ElementsPublicSubClass.length);
	}
