 ...
 * @since	2002/08/15
 */
public class Aggregation_CLASS_INSTANCE_FROM_FIELD_1_Test
		extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (Aggregation_CLASS_INSTANCE_FROM_FIELD_1_Test.FirstClassEntities == null
			...
			Aggregation_CLASS_INSTANCE_FROM_FIELD_1_Test.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(idiomLevelModel);

			Aggregation_CLASS_INSTANCE_FROM_FIELD_1_Test.Elements = Util
					.getArrayOfElements(
							Aggregation_CLASS_INSTANCE_FROM_FIELD_1_Test.FirstClassEntities[2]);
		}
	}

	public void testAggregation() {
		ClassFilePrimitive.assertAssigable("Aggregation link type",
				IAggregation.class,
