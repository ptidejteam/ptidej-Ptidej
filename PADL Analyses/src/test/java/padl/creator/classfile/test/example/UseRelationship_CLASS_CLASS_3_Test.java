...
public class UseRelationship_CLASS_CLASS_3_Test extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (UseRelationship_CLASS_CLASS_3_Test.FirstClassEntities == null
			...
			codeLevelModel.create(new CompleteClassFileCreator(new String[] {
					"../PADL Creator ClassFile/target/test-classes/padl/example/relationship/UseRelationship_CLASS_CLASS_3.class" }));

			final IIdiomLevelModel idiomLevelModel = (IIdiomLevelModel) new AACRelationshipsAnalysis()
					.invoke(codeLevelModel);

			UseRelationship_CLASS_CLASS_3_Test.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(idiomLevelModel);

			UseRelationship_CLASS_CLASS_3_Test.Elements = Util
					.getArrayOfElements(
							UseRelationship_CLASS_CLASS_3_Test.FirstClassEntities[2]);
		}
	}

	public void testConstructor() {
		Assert.assertEquals("Constructor", "UseRelationship_CLASS_CLASS_3",
				UseRelationship_CLASS_CLASS_3_Test.Elements[0]
						.getDisplayName());
	}
	...
	public void testMethod() {
		Assert.assertEquals("Method", "foo",
				UseRelationship_CLASS_CLASS_3_Test.Elements[2]
						.getDisplayName());
	}
