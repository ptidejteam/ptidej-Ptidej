 ...
 * @since  2005/11/11
 */
public class PrivateConstructorTest extends TestCase {
	private static IIdiomLevelModel IdiomLevelModel;
	public PrivateConstructorTest(final String aName) {
		super(aName);
	}
	public void setUp() throws Exception {
		if (PrivateConstructorTest.IdiomLevelModel == null) {
			...
			PrivateConstructorTest.IdiomLevelModel =
	...
	public void testElementsOfRestrictedCreation() {
		final IClass clazz =
			(IClass) PrivateConstructorTest.IdiomLevelModel
