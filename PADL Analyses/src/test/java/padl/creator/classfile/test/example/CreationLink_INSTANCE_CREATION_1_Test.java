...
public class CreationLink_INSTANCE_CREATION_1_Test extends ClassFilePrimitive {
	...
	protected void setUp() throws CreationException,
		...
		if (CreationLink_INSTANCE_CREATION_1_Test.FirstClassEntities == null
			...
			CreationLink_INSTANCE_CREATION_1_Test.FirstClassEntities =
				Util.getArrayOfTopLevelEntities(idiomLevelModel);

			CreationLink_INSTANCE_CREATION_1_Test.Elements =
				Util
					.getArrayOfElements(CreationLink_INSTANCE_CREATION_1_Test.FirstClassEntities[2]);
		}
	}
	public void testConstructor() {
		Assert.assertEquals(
			...
			CreationLink_INSTANCE_CREATION_1_Test.Elements[0].getDisplayName());
	}
	public void testMethod() {
		Assert.assertEquals(
			"Method",
			"foo",
			CreationLink_INSTANCE_CREATION_1_Test.Elements[2].getDisplayName());
	}
	public void testAssociation() {
		...
		Assert.assertEquals("Association relationship visibility", Modifier
			...
			.toString(CreationLink_INSTANCE_CREATION_1_Test.Elements[1]
				.getVisibility()));
		Assert.assertEquals(
		...
		Assert.assertEquals(
			...
			CreationLink_INSTANCE_CREATION_1_Test.Elements[1].getDisplayName());
		Assert.assertEquals(
	...
	public void testCreationLink() {
		...
		Assert.assertEquals("Creation link visibility", Modifier
			...
			.toString(CreationLink_INSTANCE_CREATION_1_Test.Elements[3]
				.getVisibility()));
		Assert.assertEquals(
		...
		Assert.assertEquals(
			...
			CreationLink_INSTANCE_CREATION_1_Test.Elements[3].getDisplayName());
		Assert.assertEquals(
