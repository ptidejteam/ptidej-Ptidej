...
public class Composite4AbstractDocumentTest extends ClassFilePrimitive {
	...
	protected void setUp()
		...
		if (Composite4AbstractDocumentTest.FirstClassEntities == null
			...
			codeLevelModel.create(new CompleteClassFileCreator(new String[] {
					"../PADL Creator ClassFile/target/test-classes/padl/example/relationship/Composite4AbstractDocument.class" }));

			final IIdiomLevelModel idiomLevelModel = (IIdiomLevelModel) new AACRelationshipsAnalysis()
					.invoke(codeLevelModel);

			Composite4AbstractDocumentTest.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(idiomLevelModel);

			Composite4AbstractDocumentTest.Elements = Util.getArrayOfElements(
					Composite4AbstractDocumentTest.FirstClassEntities[4]);
		}
	}

	public void testConstructor() {
		Assert.assertEquals("Constructor", "Composite4AbstractDocument",
	...
	public void testMethod() {
		Assert.assertEquals("Method", "print",
	...
	public void testUseRelationship2() {
		...
		Assert.assertEquals("Use relationship target", "java.lang.Class",
				((IUseRelationship) Composite4AbstractDocumentTest.Elements[4])
						.getTargetEntity().getDisplayID());
	}
