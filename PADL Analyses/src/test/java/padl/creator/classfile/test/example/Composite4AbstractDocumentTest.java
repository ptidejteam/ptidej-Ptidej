 ...
 * @since	2002/08/15
 */
public class Composite4AbstractDocumentTest extends ClassFilePrimitive {
	private static IFirstClassEntity[] FirstClassEntities = null;
	private static IElement[] Elements = null;

	public Composite4AbstractDocumentTest(final String name) {
		super(name);
	}
	protected void setUp() throws CreationException,
			UnsupportedSourceModelException {

		if (Composite4AbstractDocumentTest.FirstClassEntities == null
				|| Composite4AbstractDocumentTest.Elements == null) {
			...
			codeLevelModel
				.create(new CompleteClassFileCreator(
					new String[] { "../PADL Creator ClassFile/target/test-classes/padl/example/relationship/Composite4AbstractDocument.class" }));

			final IIdiomLevelModel idiomLevelModel =
				(IIdiomLevelModel) new AACRelationshipsAnalysis()
					.invoke(codeLevelModel);

			Composite4AbstractDocumentTest.FirstClassEntities =
				Util.getArrayOfTopLevelEntities(idiomLevelModel);

			Composite4AbstractDocumentTest.Elements =
				Util
					.getArrayOfElements(Composite4AbstractDocumentTest.FirstClassEntities[4]);
		}
	}
	...
	public void testAssociation1() {
		...
		Assert
			.assertEquals(
				...
				Composite4AbstractDocumentTest.Elements[1].getDisplayName());
		Assert.assertEquals(
	...
	public void testMethod() {
		Assert.assertEquals(
			"Method",
			"print",
			Composite4AbstractDocumentTest.Elements[2].getDisplayName());
	}
	public void testUseRelationship1() {
		ClassFilePrimitive.assertAssigable(
			"Use relationship type",
			IUseRelationship.class,
			Composite4AbstractDocumentTest.Elements[3].getClass());
		Assert.assertEquals("Use relationship visibility", Modifier
			.toString(Modifier.PUBLIC), Modifier
			.toString(Composite4AbstractDocumentTest.Elements[3].getVisibility()));
		Assert.assertEquals(
		...
		Assert.assertEquals(
			...
			Composite4AbstractDocumentTest.Elements[3].getDisplayName());
		Assert.assertEquals(
	...
	public void testUseRelationship2() {
		ClassFilePrimitive.assertAssigable(
			"Use relationship type",
			IUseRelationship.class,
			Composite4AbstractDocumentTest.Elements[4].getClass());
		Assert.assertEquals("Use relationship visibility", Modifier
			.toString(Modifier.PUBLIC), Modifier
			.toString(Composite4AbstractDocumentTest.Elements[4].getVisibility()));
		Assert.assertEquals(
			"Use relationship cardinality",
			Constants.CARDINALITY_ONE,
		...
		Assert.assertEquals(
			...
			Composite4AbstractDocumentTest.Elements[4].getDisplayName());
		Assert.assertEquals(
			"Use relationship target",
			"java.lang.Class",
			((IUseRelationship) Composite4AbstractDocumentTest.Elements[4])
	...
	public void testAssociation2() {
		ClassFilePrimitive.assertAssigable(
			"Association relationship type",
			IAssociation.class,
			Composite4AbstractDocumentTest.Elements[5].getClass());
		Assert.assertEquals("Association relationship visibility", Modifier
			.toString(Modifier.PUBLIC), Modifier
			.toString(Composite4AbstractDocumentTest.Elements[5].getVisibility()));
		Assert.assertEquals(
			"Association relationship cardinality",
			Constants.CARDINALITY_ONE,
		...
		Assert.assertEquals(
			...
			Composite4AbstractDocumentTest.Elements[5].getDisplayName());
		Assert.assertEquals(
			"Association relationship target",
			"java.io.PrintStream",
			((IAssociation) Composite4AbstractDocumentTest.Elements[5])
	...
	public void testNumberOfElements() {
		Assert.assertEquals(
			"Number of elements",
			7,
			Composite4AbstractDocumentTest.Elements.length);
	}
	public void testNumberOfEntities() {
		Assert.assertEquals(
			"Number of entities",
			5,
			Composite4AbstractDocumentTest.FirstClassEntities.length);
	}
}
