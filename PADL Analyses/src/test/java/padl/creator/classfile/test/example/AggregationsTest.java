...
public class AggregationsTest extends ClassFilePrimitive {
	...
	public void testAggregation12() {
		...
		ClassFilePrimitive.assertAssigable("Container aggregation type",
				IContainerAggregation.class, elements[3].getClass());
		...
		Assert.assertEquals("Container aggregation target",
				"padl.example.aggregation.A",
				((IContainerAggregation) elements[3]).getTargetEntity()
						.getDisplayID());
		...
		Assert.assertEquals("Use relationship target",
				"padl.example.aggregation.A", ((IUseRelationship) elements[5])
	...
	public void testAggregation2() {
		Assert.assertEquals("Aggregation 2",
				"padl.example.aggregation.Aggregation2",
				AggregationsTest.FirstClassEntities[9].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[9]);

		Assert.assertEquals("Identified elements", 5, elements.length);

		Assert.assertEquals("Constructor", "Aggregation2",
				elements[0].getDisplayName());
	...
	public void testAggregation3() {
		Assert.assertEquals("Aggregation 3",
				"padl.example.aggregation.Aggregation3",
				AggregationsTest.FirstClassEntities[10].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[10]);

		Assert.assertEquals("Identified elements", 5, elements.length);

		Assert.assertEquals("Constructor", "Aggregation3",
				elements[0].getDisplayName());
		...
		Assert.assertEquals("Method setA()", "setA",
				elements[3].getDisplayName());
		...
		Assert.assertEquals("Use relationship name",
				...
				elements[4].getDisplayName());
		Assert.assertEquals("Use relationship target",
				"padl.example.aggregation.A", ((IUseRelationship) elements[4])
						.getTargetEntity().getDisplayID());
	}

	public void testAggregation4() {
		Assert.assertEquals("Aggregation 4",
				"padl.example.aggregation.Aggregation4",
				AggregationsTest.FirstClassEntities[11].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[11]);

		Assert.assertEquals("Identified elements", 9, elements.length);

		Assert.assertEquals("Constructor", "Aggregation4",
				elements[0].getDisplayName());
		...
		ClassFilePrimitive.assertAssigable("ContainerAggregation link type",
				IContainerAggregation.class, elements[3].getClass());
		...
		Assert.assertEquals("ContainerAggregation link name",
				"padl.kernel.impl.ContainerAggregation:padl.example.aggregation.A:2",
				elements[3].getDisplayName());
		Assert.assertEquals("ContainerAggregation link target",
				"padl.example.aggregation.A",
				((IContainerAggregation) elements[3]).getTargetEntity()
						.getDisplayID());
	...
	public void testAggregation5() {
		Assert.assertEquals("Aggregation 5",
				"padl.example.aggregation.Aggregation5",
				AggregationsTest.FirstClassEntities[12].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[12]);

		Assert.assertEquals("Identified elements", 8, elements.length);

		Assert.assertEquals("Constructor", "Aggregation5",
				elements[0].getDisplayName());
	...
	public void testAggregation6() {
		Assert.assertEquals("Aggregation 6",
				"padl.example.aggregation.Aggregation6",
				AggregationsTest.FirstClassEntities[13].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[13]);

		Assert.assertEquals("Identified elements", 6, elements.length);

		Assert.assertEquals("Constructor", "Aggregation6",
				elements[0].getDisplayName());
	...
	public void testAggregation7() {
		Assert.assertEquals("Aggregation 7",
				"padl.example.aggregation.Aggregation7",
				AggregationsTest.FirstClassEntities[14].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[14]);

		Assert.assertEquals("Identified elements", 6, elements.length);

		Assert.assertEquals("Constructor", "Aggregation7",
				elements[0].getDisplayName());
	...
	public void testAggregation8() {
		Assert.assertEquals("Aggregation 8",
				"padl.example.aggregation.Aggregation8",
				AggregationsTest.FirstClassEntities[15].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[15]);

		Assert.assertEquals("Identified elements", 5, elements.length);

		Assert.assertEquals("Constructor", "Aggregation8",
				elements[0].getDisplayName());
	...
	public void testAggregation9() {
		Assert.assertEquals("Aggregation 9",
				"padl.example.aggregation.Aggregation9",
				AggregationsTest.FirstClassEntities[16].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[16]);

		Assert.assertEquals("Identified elements", 9, elements.length);

		Assert.assertEquals("Constructor", "Aggregation9",
				elements[0].getDisplayName());
		...
		Assert.assertEquals("Method addToA()", "addToA",
				elements[4].getDisplayName());
		...
		Assert.assertEquals("Method removeFromA()", "removeFromA",
				elements[8].getDisplayName());
	}

	public void testEntity1() {
		Assert.assertEquals("Entity 1", "padl.example.aggregation.A",
				AggregationsTest.FirstClassEntities[2].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[2]);
		...
		Assert.assertEquals("Constructor", "instanceMethod",
				elements[2].getDisplayName());

		Assert.assertEquals("Constructor", "staticMethod",
				elements[3].getDisplayName());
	}

	public void testEntity2() {
		Assert.assertEquals("Entity 2", "java.lang.Object",
				AggregationsTest.FirstClassEntities[0].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[0]);
	...
	public void testEntity3() {
		Assert.assertEquals("Entity 3", "java.util.List",
				AggregationsTest.FirstClassEntities[1].getDisplayID());

		final IElement[] elements = Util
				.getArrayOfElements(AggregationsTest.FirstClassEntities[1]);
		// Farouk 2004/04/01: Method invocations.
	...
	public void testNumberOfEntities() {
		Assert.assertEquals("Number of entities", 17,
				AggregationsTest.FirstClassEntities.length);
	}
}
