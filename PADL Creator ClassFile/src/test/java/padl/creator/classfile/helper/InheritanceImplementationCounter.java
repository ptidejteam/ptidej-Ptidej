 ...
 ******************************************************************************/
package padl.creator.classfile.helper;
...
public class InheritanceImplementationCounter implements IWalker {
	...
	public Object getResult() {
		return Integer.valueOf(this.numerOfImplementationRelationships + this.numerOfInheritanceRelationships);
	}
	...
	public void open(final IClass aClass) {
		this.numerOfImplementationRelationships += aClass.getNumberOfImplementedInterfaces();
		this.numerOfInheritanceRelationships += aClass.getNumberOfInheritedEntities();
	}
	...
	public void open(final IInterface anInterface) {
		this.numerOfInheritanceRelationships += anInterface.getNumberOfInheritedEntities();
	}
