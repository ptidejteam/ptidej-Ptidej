...
public class PetStorev131 {
	...
	public void testGenerateModelFromClassFiles() {
		...
		final IIdiomLevelModel idiomLevelModel = ModelGenerator
				.generateModelFromClassFilesDirectories("PetStore v1.3.1",
						new String[] {
								"C:/Data/Java Programs/petstore1.3.1_02/src/bin/" },
						statistics);
		Assert.assertEquals("Number of classes", 502,
