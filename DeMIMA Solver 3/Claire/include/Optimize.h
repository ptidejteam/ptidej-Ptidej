// interface defination for module Optimize, Sat Sep 14 18:03:03 2002
...
class ClairePattern;
class optUnion;
class Call_function2;

class meta_OPT: public thing{ 
  public:
     list *instructions;
     list *objects;
     set *properties;
...
class meta_compiler: public thing{ 
  public:
     char *external;
     list *headers;
     char *source;
...
class to_protect: public Optimized_instruction{ 
  public:
     OID arg;} 
;

class to_CL: public Optimized_instruction{ 
  public:
     OID arg;
     ClaireClass *set_arg;} 
;

class to_C: public Optimized_instruction{ 
  public:
     OID arg;
     ClaireClass *set_arg;} 
;

class C_cast: public to_C{ 
  public:} 
;

class ClairePattern: public Type{ 
  public:
     property *selector;
     list *arg;} 
;

class optUnion: public Union{ 
  public:} 
;

class Call_function2: public Optimized_instruction{ 
  public:
     ClaireFunction *arg;
     list *args;} 
;
...
extern OID  stats_meta_OPT(meta_OPT *v5264);
extern void  self_print_to_protect(to_protect *v5264);
extern OID  self_eval_to_protect(to_protect *v5264);
extern void  self_print_to_CL(to_CL *v9268);
extern ClaireType * c_type_to_CL_Optimize(to_CL *v9268);
extern ClaireBoolean * c_gc_ask_to_CL(to_CL *v9268);
extern void  self_print_to_C(to_C *v9268);
extern ClaireBoolean * c_gc_ask_to_C(to_C *v9268);
extern ClaireType * c_type_to_C_Optimize(to_C *v9268);
extern void  self_print_C_cast(C_cast *v9268);
extern ClaireBoolean * c_gc_ask_C_cast(C_cast *v9268);
extern ClaireType * c_type_C_cast_Optimize(C_cast *v9268);
extern OID  c_code_C_cast_Optimize(C_cast *v9268,ClaireClass *v5259);
extern void  self_print_Pattern(ClairePattern *v9268);
extern ClaireBoolean * _Z_any3(OID v5264,ClairePattern *v5265);
extern ClaireType * glb_Pattern(ClairePattern *v5264,ClaireType *v5265);
extern ClaireBoolean * less_ask_Pattern(ClairePattern *v5264,OID v5265);
extern ClaireBoolean * less_ask_any(OID v5264,ClairePattern *v5265);
extern ClairePattern * nth_property(property *v5256,tuple *v5264);
extern OID  warn_void();
...
extern OID  self_code_Pattern(ClairePattern *v9268);
...
extern ClaireType * c_type_to_protect_Optimize(to_protect *v9268);
extern OID  c_code_to_protect_Optimize(to_protect *v9268);
extern ClaireBoolean * c_gc_ask_to_protect(to_protect *v9268);
...
extern void  self_print_Call_function2(Call_function2 *v9268);
extern ClaireType * c_type_Call_function2_Optimize(Call_function2 *v9268);
extern OID  c_code_Call_function2_Optimize(Call_function2 *v9268);
...
extern OID  Tighten_relation2(ClaireRelation *v5258);
...
extern void  compileEventMethod_property(property *v5256);
...
global_variable * _starsimple_operations_star;
global_variable * _starnon_identifiable_set_star;
keyword * ambiguous;
