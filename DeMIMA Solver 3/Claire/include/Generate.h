// interface defination for module Generate, Sat Sep 14 18:03:09 2002
...
class c_producer: public producer{ 
  public:
     list *bad_names;
     list *good_names;} 
;
...
extern OID  generate_functions_module(module *v1140);
...
extern OID  get_dependents_method(method *v7237);
extern void  c_princ_function(ClaireFunction *v1140);
extern OID  set_outfile_lambda(lambda *v1140);
...
extern void  expression_to_protect(to_protect *v1140,OID v15308);
...
extern void  expression_to_CL(to_CL *v1140,OID v15308);
extern void  expression_to_C(to_C *v1140,OID v15308);
extern void  expression_C_cast(C_cast *v1140,OID v15308);
...
extern void  bool_exp_to_CL_Generate(to_CL *v1140,ClaireBoolean *v3475,OID v15308);
...
extern void  self_statement_to_protect(to_protect *v1140,OID v7243,OID v15308);
...
extern void  self_statement_to_CL(to_CL *v1140,OID v7243,OID v15308);
extern void  self_statement_to_C(to_C *v1140,OID v7243,OID v15308);
extern void  self_statement_C_cast(C_cast *v1140,OID v7243,OID v15308);
...
extern char * string_I_c_producer1(c_producer *v7227,Variable *v1140);
extern char * string_I_c_producer2(c_producer *v7227,symbol *v1140);
extern void  ident_c_producer3(c_producer *v7227,Variable *v7247);
extern void  ident_c_producer(c_producer *v7227,symbol *v7243);
extern void  produce_c_producer2(c_producer *v7227,OID v7248);
extern void  stat_exp_c_producer(c_producer *v7227,OID v1140,OID v15308);
extern void  namespace_I_c_producer(c_producer *v7227,module *v7237);
extern void  module_I_c_producer(c_producer *v7227,module *v7237);
extern void  declare_c_producer(c_producer *v7227,property *v7240);
extern void  start_module_interface_c_producer(c_producer *v7227,module *v1140);
extern void  end_module_interface_c_producer(c_producer *v7227,module *v1140);
extern void  generate_end_file_c_producer(c_producer *v7234,module *v7237);
extern void  generate_classes_c_producer(c_producer *v7234,char *v7243,module *v7237);
extern void  generate_start_file_c_producer(c_producer *v7227,module *v7237);
extern void  generate_meta_load_c_producer(c_producer *v7227,module *v7237);
extern OID  start_file_string(char *v7243,module *v7237);
extern void  define_variable_c_producer2(c_producer *v7227,ClaireClass *v7244,char *v7247);
extern void  generate_profile_c_producer(c_producer *v7227,OID v7237);
extern void  generate_interface_c_producer(c_producer *v7227,module *v1140);
extern void  gc_introduction_c_producer(c_producer *v7227,OID v9221);
...
extern void  debug_intro_c_producer(c_producer *v7227,lambda *v1140,method *v7248);
extern char * protect_result_c_producer(c_producer *v7227,ClaireClass *v7243,ClaireBoolean *v13756,OID v7248);
extern void  generate_function_start_c_producer(c_producer *v7227,lambda *v1140,ClaireClass *v7243,OID v7237,char *v12719);
extern void  generate_regular_function_c_producer(c_producer *v7227,lambda *v1140,ClaireFunction *v9226,ClaireClass *v7243,OID v7237,list *v11442);
extern void  generate_float_function_c_producer(c_producer *v7227,method *v7237,char *v12719);
extern void  at_c_producer(c_producer *v7227);
extern void  generate_tuple_function_c_producer(c_producer *v7227,method *v7237,char *v12719);
extern OID  create_function_entry_c_producer(c_producer *v7227,lambda *v11422,char *v9226,OID v7237);
extern OID  update_function_entry_c_producer(c_producer *v7227,ClaireFunction *v9226,list *v11442,ClaireClass *v7243);
...
extern void  interface_I_c_producer(c_producer *v7227,ClaireClass *v1140);
extern void  to_cl_c_producer(c_producer *v7227,OID v7248,ClaireClass *v7243,OID v15308);
extern void  to_c_c_producer1(c_producer *v7227,OID v7248,ClaireClass *v7243,OID v15308);
extern void  to_c_c_producer2(c_producer *v7227,ClaireClass *v7243);
extern OID  public_static_c_producer(c_producer *v7227);
extern void  bool_exp_I_c_producer(c_producer *v7227,OID v1140,OID v15308);
extern void  inherit_exp_c_producer(c_producer *v7227,OID v11032,OID v11033,OID v15308);
extern void  bitvector_exp_c_producer(c_producer *v7227,OID v11032,OID v11033,OID v15308);
extern void  equal_exp_c_producer(c_producer *v7227,OID v11032,ClaireBoolean *v3475,OID v11033,OID v7260);
extern ClaireBoolean * char_exp_ask_c_producer2(c_producer *v7227,OID v7248);
extern void  char_exp_c_producer2(c_producer *v7227,OID v7248,OID v15308);
extern void  c_member_c_producer(c_producer *v7227,OID v1140,ClaireClass *v7243,property *v7248,OID v15308);
extern void  addFast_c_producer(c_producer *v7227);
extern void  cast_I_c_producer(c_producer *v7227,C_cast *v1140,OID v15308);
extern void  gc_protection_exp_c_producer(c_producer *v7227,Variable *v7247,ClaireBoolean *v12010,OID v7245,OID v15308);
extern void  bag_expression_c_producer(c_producer *v11165,ClaireClass *v7227,bag *v7236,ClaireType *v7244,OID v15308);
extern void  generate_system_file_string(char *v1140,list *v7236);
extern void  create_loadModules_string(char *v1140,ClairePort *v7240,list *v10516);
extern void  methods_interface_c_producer(c_producer *v7227,ClaireClass *v7248);
extern void  methods_bodies_c_producer(c_producer *v7227,ClaireClass *v7248);
extern void  inline_exp_c_producer1(c_producer *v7227,Call_method1 *v1140,OID v15308);
extern void  inline_exp_c_producer2(c_producer *v7227,Call_method2 *v1140,OID v15308);
extern void  inline_exp_c_producer3(c_producer *v7227,Call_method *v1140,OID v15308);
extern void  print_external_call_c_producer(c_producer *v7227,Call_method *v1140,OID v15308);
extern void  inline_exp_c_producer5(c_producer *v7227,Call *v1140,OID v15308);
...
extern OID  c_sorted_arg_any(OID v7248,ClaireClass *v7243,OID v15308,ClaireBoolean *v4284);
extern OID  c_sorted_args_Call(Call *v7248,list *v11439,OID v15308,ClaireBoolean *v4284);
extern void  bitvector_I_c_producer(c_producer *v7227,OID v7248);
extern void  bitvectorSum_integer(int v7248);
extern void  signature_I_c_producer(c_producer *v7227,OID v7248);
extern OID  getC_any(OID v7248);
extern void  gassign_c_producer(c_producer *v7227,Gassign *v1140,OID v15308);
extern void  call_slot_c_producer(c_producer *v7227,Call_slot *v1140,OID v15308);
extern void  call_table_c_producer(c_producer *v7227,Call_table *v1140,OID v15308);
extern void  call_array_c_producer(c_producer *v7227,Call_array *v1140,OID v15308);
extern OID  update_c_producer(c_producer *v7227,Update *v1140,OID v15308);
extern void  object_test_c_producer(c_producer *v7227,OID v11032,ClaireBoolean *v3475,OID v15308);
extern void  exp_to_protect_c_producer(c_producer *v7227,to_protect *v1140,OID v15308);
extern void  macro_c_producer(c_producer *v7227);
extern void  init_var_c_producer(c_producer *v7227,ClaireClass *v7243);
extern void  any_interface_c_producer(c_producer *v7227);
extern void  pointer_cast_c_producer(c_producer *v7227,ClaireClass *v7243);
extern void  exp_Assign_c_producer(c_producer *v7227,Assign *v1140,OID v15308);
extern void  stat_handle_c_producer(c_producer *v7227,ClaireHandle *v1140,OID v7243,OID v15308);
extern void  stat_construct_c_producer(c_producer *v7227,Construct *v1140,OID v7243,OID v15308);
extern void  stat_while_c_producer(c_producer *v7227,While *v1140,OID v7243,OID v15308);
extern void  stat_gassign_c_producer(c_producer *v7227,Gassign *v1140,OID v7243,OID v15308);
extern void  stat_for_c_producer(c_producer *v7227,For *v1140,OID v7243,OID v15308);
extern void  stat_iteration_c_producer(c_producer *v7227,Iteration *v1140,OID v7243,OID v15308);
extern void  stat_super_c_producer(c_producer *v7227,Super *v1140,OID v7243,OID v15308);
extern void  stat_let_c_producer(c_producer *v7227,Let *v1140,OID v7243,OID v15308);
...
global_variable * _starch_sign_star;
global_variable * _star_star_integer_star;
global_variable * _star_plus_integer_star;
global_variable * _star_dash_integer_star;
global_variable * _stardiv_integer_star;
...
c_producer * C_plus_plusPRODUCER;
property * fcall_ask;
property * fcall_exp;
...
property * generate_system_file;// Generate/"generate_system_file"
property * create_loadModules;// Generate/"create_loadModules"
