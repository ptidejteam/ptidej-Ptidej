// interface defination for module Reader, Sat Sep 14 18:02:58 2002
...
extern OID  keyword_ask_any(OID x);
...
extern OID  float_I_string_(char *g0075);
...
extern OID  spy_listargs2_Reader(listargs *l);
...
extern OID  PRshow_void();
extern set * dependents_method(method *self);
extern OID  dependents_any(OID self);
extern OID  PRdepends_property(property *p,property *p2);
...
global_variable * _stararrow_star;
...
global_variable * AND;
global_variable * OR;
global_variable * StrictClaire2;
global_variable * Declarations;
global_variable * LastExpRead;
table * DBline;
meta_reader * reader;
...
global_variable * step_I;
global_variable * get_stack;
property * execute_do;
property * execute_bk;
