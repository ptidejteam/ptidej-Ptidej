// interface defination for module Core, Sat Sep 14 18:02:42 2002
#ifndef CLAIREH_Core
#define CLAIREH_Core
...
extern OID  erase_table(table *a);
...
extern OID  reify_listargs(listargs *l);
...
extern OID  self_print_symbol_Core(symbol *self);
...
extern OID  _plus_float_(OID g0054,OID g0055);
extern double  _dash_float(double self,double x);
extern OID  _dash_float_(OID g0056,OID g0057);
extern double  _star_float(double self,double x);
extern OID  _star_float_(OID g0058,OID g0059);
extern double  _7_float(double self,double x);
extern OID  _7_float_(OID g0060,OID g0061);
extern double  _dash_float2(double self);
extern OID  _dash_float2_(OID g0062);
extern double  sqrt_float(double self);
extern OID  sqrt_float_(OID g0063);
extern double  _exp_float(double self,double x);
extern OID  _exp_float_(OID g0064,OID g0065);
extern double  log_float(double self);
extern OID  log_float_(OID g0066);
extern double  atan_float(double self);
extern OID  atan_float_(OID g0067);
extern char * string_I_float(double self);
extern char * string_I_float_(OID g0068);
...
extern OID  self_print_array_Core(OID *self);
extern OID  self_print_char_Core(ClaireChar *self);
...
extern ClaireType * nth_get_array_type(ClaireType *a,ClaireType *n);
