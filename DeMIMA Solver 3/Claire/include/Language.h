// interface defination for module Language, Sat Sep 14 18:02:51 2002
...
class rule_object: public property{ 
  public:} 
;
...
extern OID  sugar_ask_any(OID x,OID x2,OID o,OID a);
...
extern void  self_print_demon(demon *self);
extern OID  funcall_demon1(demon *self,OID x,OID y);
extern OID  funcall_demon2(demon *self,OID x,OID y,OID z);
...
extern tuple * make_filter_any_(OID g0063);
extern demon * make_demon_relation(ClaireRelation *R,symbol *n,list *lvar,OID cond,OID conc);
