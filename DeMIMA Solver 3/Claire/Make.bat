...
if "%OS%" == "Windows_NT" set PATH=%PATH%;%MSDevDir%\BIN;%MSVCDir%\BIN;%VSCommonDir%\TOOLS\%VcOsDir%;%VSCommonDir%\TOOLS
...
CD C:\Documents and Settings\Yann\Work\Ptidej Solver 3\Claire\
nmake -f Makefile.nt
Pause