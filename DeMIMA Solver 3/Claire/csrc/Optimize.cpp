/***** CLAIRE Compilation of file Optimize.cl 
         [version 3.2.52 / safety 5] Sat Sep 14 18:03:06 2002 *****/
...
// definition of the properties 
  ...
  { (Optimize._meta_OPT = ClaireClass::make("meta_OPT",Kernel._thing,Optimize.it));
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.instructions,instructions,Kernel._list,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.objects,objects,Kernel._list,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.properties,properties,nth_class2(Kernel._set,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._property))))),CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.functions,functions,Kernel._list,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.need_to_close,need_to_close,Kernel._set,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.need_modules,need_modules,Kernel._set,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.legal_modules,legal_modules,Kernel._set,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.allocation,allocation,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.protection,protection,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.alloc_stack,alloc_stack,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.ignore,ignore,Kernel._set,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.to_remove,to_remove,Kernel._set,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.cinterface,cinterface,Kernel._port,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.outfile,outfile,Kernel._port,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.max_vars,max_vars,Kernel._integer,0);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.loop_gc,loop_gc,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.loop_index,loop_index,Kernel._integer,0);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.level,level,Kernel._integer,0);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.in_method,in_method,Kernel._any,CNULL);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.profile_ask,profile_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.cfile,cfile,Kernel._any,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.use_update,use_update,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.use_nth_equal,use_nth_equal,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.online_ask,online_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.recompute,recompute,Kernel._boolean,Kernel.ctrue);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.unsure,unsure,Kernel._list,Core.nil->value);
    CL_ADD_SLOT(Optimize._meta_OPT,meta_OPT,Optimize.knowns,knowns,nth_class2(Kernel._set,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._relation))))),CNULL);
    } 
  
  { (Optimize._meta_compiler = ClaireClass::make("meta_compiler",Kernel._thing,Optimize.it));
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Kernel.external,external,Kernel._string,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.headers,headers,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._string))))),CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Kernel.source,source,Kernel._string,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.debug_ask,debug_ask,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._module))))),CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Kernel.version,version,Kernel._any,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.active_ask,active_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.safety,safety,Kernel._integer,1);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.env,env,Kernel._string,_string_("ntw"));
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.naming,naming,Kernel._integer,0);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.libraries,libraries,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._string))))),CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Kernel.inline_ask,inline_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.loading_ask,loading_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.class2file_ask,class2file_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.greedy_ask,greedy_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.libraries_dir,libraries_dir,Kernel._list,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.headers_dir,headers_dir,Kernel._string,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.options,options,Kernel._list,CNULL);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.overflow_ask,overflow_ask,Kernel._boolean,Kernel.cfalse);
    CL_ADD_SLOT(Optimize._meta_compiler,meta_compiler,Optimize.diet_ask,diet_ask,Kernel._boolean,Kernel.cfalse);
    } 
  ...
  { global_variable * v2072 = (Optimize.claire_modules = (global_variable *) Core._global_variable->instantiate("claire_modules",claire.it));
    ...
    { global_variable * v10529; 
      OID  v10530;
      v10529 = v2072;
      { list * v12158;{ bag *v_list; OID v_val;
          OID v5264,CLcount;
  ...
  { (Optimize.compiler = (meta_compiler *) Optimize._meta_compiler->instantiate("compiler",claire.it));
    (Optimize.compiler->external = "MS VC++");
    (Optimize.compiler->env = "ntv");
    (Optimize.compiler->version = _float_(2.52));
  ...
  { (Optimize._to_protect = ClaireClass::make("to_protect",Language._Optimized_instruction,Compile.it));
    CL_ADD_SLOT(Optimize._to_protect,to_protect,Kernel.arg,arg,Kernel._any,CNULL);
    } 
  
  { (Optimize._to_CL = ClaireClass::make("to_CL",Language._Optimized_instruction,Compile.it));
    CL_ADD_SLOT(Optimize._to_CL,to_CL,Kernel.arg,arg,Kernel._any,CNULL);
    CL_ADD_SLOT(Optimize._to_CL,to_CL,Language.set_arg,set_arg,Kernel._class,CNULL);
    } 
  
  { (Optimize._to_C = ClaireClass::make("to_C",Language._Optimized_instruction,Compile.it));
    CL_ADD_SLOT(Optimize._to_C,to_C,Kernel.arg,arg,Kernel._any,CNULL);
    CL_ADD_SLOT(Optimize._to_C,to_C,Language.set_arg,set_arg,Kernel._class,CNULL);
    } 
  ...
  { (Optimize._Pattern = ClaireClass::make("Pattern",Core._Type,Optimize.it));
    CL_ADD_SLOT(Optimize._Pattern,ClairePattern,Kernel.selector,selector,Kernel._property,CNULL);
    CL_ADD_SLOT(Optimize._Pattern,ClairePattern,Kernel.arg,arg,Kernel._list,CNULL);
    } 
  
  { (Optimize.OPT = (meta_OPT *) Optimize._meta_OPT->instantiate("OPT",claire.it));
  ...
  Optimize.stats->addMethod(list::domain(1,Optimize._meta_OPT),Kernel._any,
  ...
  Optimize.warn->addMethod(list::domain(1,Kernel._void),Kernel._any,
  ...
  { global_variable * v2072 = (Optimize._starsimple_operations_star = (global_variable *) Core._global_variable->instantiate("*simple_operations*",Optimize.it));
    (v2072->range = Kernel._set);
    (v2072->value = _oid_(set::alloc(Kernel.emptySet,4,_oid_(Kernel._dash),
      _oid_(Kernel._7),
      _oid_(Kernel._star),
      _oid_(Core._plus))));
    close_global_variable(v2072);
  ...
  { global_variable * v2072 = (Optimize._starnon_identifiable_set_star = (global_variable *) Core._global_variable->instantiate("*non_identifiable_set*",Optimize.it));
    (v2072->range = Kernel._set);
    (v2072->value = _oid_(set::alloc(Kernel._class,14,_oid_(Kernel._object),
      _oid_(Kernel._primitive),
      _oid_(Kernel._import),
  ...
  Optimize.nth_type_check->addMethod(list::domain(3,Kernel._type,Kernel._type,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG,_function_(nth_type_check_type,"nth_type_check_type"))->inlineDef("lambda[(tl:type,ti:type,tx:type),(if not(tx <= member(tl)) (Compile/warn(), trace(2, \"unsafe update on bag: type ~S into ~S\\n\", tx, tl)) else false, tx)]");
  ...
  { (Optimize._Call_function2 = ClaireClass::make("Call_function2",Language._Optimized_instruction,Optimize.it));
    CL_ADD_SLOT(Optimize._Call_function2,Call_function2,Kernel.arg,arg,Kernel._function,CNULL);
    CL_ADD_SLOT(Optimize._Call_function2,Call_function2,Core.args,args,Kernel._list,CNULL);
    } 
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._For),Kernel._type,
  	0,_function_(c_type_For_Optimize,"c_type_For_Optimize"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._While),Kernel._type,
  	0,_function_(c_type_While_Optimize,"c_type_While_Optimize"));
  ...
  Language.iterate->addMethod(list::domain(3,Core._Interval,nth_class2(Language._Variable,list::alloc(Kernel._any,1,_oid_(Kernel.range)),list::alloc(Kernel.emptySet,1,GC_OID(_oid_(nth_class1(Kernel._type,Kernel._integer))))),Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(iterate_Interval,"iterate_Interval"))->inlineDef("lambda[(x:Interval,v:Variable[range:(subtype[integer])],e:any),let v := eval(x.arg1, Interval),%max:integer := eval(x.arg2, Interval) in while (v <= %max) (e, v :+ 1)]");
  
  Language.iterate->addMethod(list::domain(3,Kernel._array,Language._Variable,Kernel._any),Kernel._any,
  	0,_function_(iterate_array,"iterate_array"))->inlineDef("lambda[(x:array,v:Variable,e:any),let %i := 1,%a := x,%max := length(%a) in while (%i <= %max) let v := %a[%i] in (e, %i :+ 1)]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Kernel._dot_dot,tuple::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer))),Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(Iterate_any1,"Iterate_any1"))->inlineDef("lambda[(x:..[tuple(integer,integer)],v:Variable,e:any),let v := eval(x.args[1]),%max := eval(x.args[2]) in while (v <= %max) (e, v :+ 1)]");
  ...
  Optimize.Tighten->addMethod(list::domain(1,Kernel._relation),Kernel._any,
  ...
  Optimize.compileEventMethod->addMethod(list::domain(1,Kernel._property),Kernel._void,
