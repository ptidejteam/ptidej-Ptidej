...
double CLMAXFLOAT = 1073741822.0;
double CLMINFLOAT = -1073741821.0;
...
// printing
void princ_float(double x) {ClEnv->cout->put(x);}
void princ_float_(OID x) {ClEnv->cout->put(float_v(x));}
