/***** CLAIRE Compilation of file d:\claire\v3.2\src\meta\pretty.cl 
...
{ return (_void_(close_exception(((general_error *) (*Core._general_error)(_string_("[144] evaluate(~S) is not defined"),
...
{ { OID Result = 0;
    ...
    else close_exception(((general_error *) (*Core._general_error)(_string_("[145] the symbol ~A is unbound"),
...
{ { OID Result = 0;
    ...
    else close_exception(((range_error *) (*Core._range_error)(_oid_(self),
        val,
        _oid_(self->range))));
      return (Result);} 
  } 
...
{ { OID Result = 0;
    { OID  i = self->index;
      ...
      else close_exception(((general_error *) (*Core._general_error)(_string_("[146] The variable ~S is not defined"),
              ...
              ((INHERIT(OWNER(self),Language._Do)) || 
                ((self == CNULL) || 
                  ((INHERIT(OWNER(self),Language._And)) || 
                    ((INHERIT(OWNER(self),Kernel._import)) || 
                          ...
                          ((INHERIT(OWNER(self),Kernel._restriction)) || 
                            ((INHERIT(OWNER(self),Kernel._unbound_symbol)) || 
                              ((INHERIT(OWNER(self),Language._Variable)) || 
                                (!INHERIT(OWNER(self),Language._Instruction))))))))))))))))
   print_any(self);
