...
_import = ClaireClass::make("import",_primitive,claire.it);
...
_port = ClaireClass::make("port",_import,claire.it);
// objects
...
nth_minus = property::make("nth-",claire.it);
...
nth_minus->addMethod(   list::domain(2,_list,_integer),_list,
