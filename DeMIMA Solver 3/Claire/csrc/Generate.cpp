/***** CLAIRE Compilation of file Generate.cl 
         [version 3.2.52 / safety 5] Sat Sep 14 18:03:11 2002 *****/
...
// definition of the properties 
  ...
  Generate.generate_system_file = property::make("generate_system_file",Generate.it);
  Generate.create_loadModules = property::make("create_loadModules",Generate.it);
  ...
  { global_variable * v2072 = (Generate._star_ask_interval_star = (global_variable *) Core._global_variable->instantiate("*?_interval*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.set_I,Core._Interval)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._star_dash_dash_integer_star = (global_variable *) Core._global_variable->instantiate("*--_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel._dot_dot,Kernel._integer)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starch_sign_star = (global_variable *) Core._global_variable->instantiate("*ch_sign*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property2(Kernel._dash,list::alloc(1,_oid_(Kernel._integer)))));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._star_star_integer_star = (global_variable *) Core._global_variable->instantiate("**_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property2(Kernel._star,list::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer)))));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._star_plus_integer_star = (global_variable *) Core._global_variable->instantiate("*+_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property2(Core._plus,list::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer)))));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._star_dash_integer_star = (global_variable *) Core._global_variable->instantiate("*-_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property2(Kernel._dash,list::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer)))));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._stardiv_integer_star = (global_variable *) Core._global_variable->instantiate("*div_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property2(Kernel._7,list::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer)))));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_integer_star = (global_variable *) Core._global_variable->instantiate("*nth_integer*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth,Kernel._integer)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_list_star = (global_variable *) Core._global_variable->instantiate("*nth_list*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth,Kernel._list)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_1_bag_star = (global_variable *) Core._global_variable->instantiate("*nth_1_bag*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth_get,Kernel._bag)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_string_star = (global_variable *) Core._global_variable->instantiate("*nth_string*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth,Kernel._string)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_1_string_star = (global_variable *) Core._global_variable->instantiate("*nth_1_string*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth_get,Kernel._string)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnth_equal_list_star = (global_variable *) Core._global_variable->instantiate("*nth=_list*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.nth_equal,Kernel._list)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnot_star = (global_variable *) Core._global_variable->instantiate("*not*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Core.NOT,Kernel._any)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starknown_star = (global_variable *) Core._global_variable->instantiate("*known*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Core.known_ask,Kernel._any)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starunknown_star = (global_variable *) Core._global_variable->instantiate("*unknown*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Core.unknown_ask,Kernel._any)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starnot_equal_star = (global_variable *) Core._global_variable->instantiate("*not_equal*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Core._I_equal,Kernel._any)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starcontain_star = (global_variable *) Core._global_variable->instantiate("*contain*",Generate.it));
    (v2072->range = Kernel._method);
    (v2072->value = _oid_(_at_property1(Kernel.contain_ask,Kernel._list)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starmin_integer_star = (global_variable *) Core._global_variable->instantiate("*min_integer*",Generate.it));
    (v2072->range = Kernel.emptySet);
    (v2072->value = _oid_(_at_property1(Core.min,Kernel._integer)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starmax_integer_star = (global_variable *) Core._global_variable->instantiate("*max_integer*",Generate.it));
    (v2072->range = Kernel.emptySet);
    (v2072->value = _oid_(_at_property1(Core.max,Kernel._integer)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starlength_array_star = (global_variable *) Core._global_variable->instantiate("*length_array*",Generate.it));
    (v2072->range = Kernel.emptySet);
    (v2072->value = _oid_(_at_property1(Kernel.length,Kernel._array)));
    close_global_variable(v2072);
    } 
  
  { global_variable * v2072 = (Generate._starlength_bag_star = (global_variable *) Core._global_variable->instantiate("*length_bag*",Generate.it));
    (v2072->range = Kernel.emptySet);
  ...
  { (Generate._producer = ClaireClass::make("producer",Kernel._thing,Generate.it));
    CL_ADD_SLOT(Generate._producer,producer,Generate.open_comparators,open_comparators,nth_class1(Kernel._list,Kernel._operation),CNULL);
    CL_ADD_SLOT(Generate._producer,producer,Generate.open_operators,open_operators,nth_class1(Kernel._list,Kernel._operation),CNULL);
    CL_ADD_SLOT(Generate._producer,producer,Kernel.body,body,Kernel._any,0);
    CL_ADD_SLOT(Generate._producer,producer,Generate.extension,extension,Kernel._string,CNULL);
    CL_ADD_SLOT(Generate._producer,producer,Kernel.comment,comment,Kernel._string,CNULL);
    CL_ADD_SLOT(Generate._producer,producer,Generate.interfaces,interfaces,Kernel._list,CNULL);
    } 
  ...
  Generate.generate_functions->addMethod(list::domain(1,Kernel._module),Kernel._any,
  ...
  Generate.get_dependents->addMethod(list::domain(1,Kernel._method),Kernel._any,
  ...
  Generate.set_outfile->addMethod(list::domain(1,Core._lambda),Kernel._any,
  ...
  { (Generate._c_producer = ClaireClass::make("c_producer",Generate._producer,Generate.it));
    CL_ADD_SLOT(Generate._c_producer,c_producer,Generate.bad_names,bad_names,nth_class1(Kernel._list,Kernel._symbol),CNULL);
    CL_ADD_SLOT(Generate._c_producer,c_producer,Generate.good_names,good_names,nth_class1(Kernel._list,Kernel._symbol),CNULL);
    } 
  
  { (Generate.C_plus_plusPRODUCER = (c_producer *) Generate._c_producer->instantiate("C++PRODUCER",Generate.it));
    ...
    (Generate.C_plus_plusPRODUCER->open_operators = list::alloc(4,_oid_(Core._plus),
      _oid_(Kernel._dash),
      _oid_(Kernel._star),
      _oid_(Kernel._7)));
    ...
    { c_producer * v6808; 
      list * v6809;
      v6808 = Generate.C_plus_plusPRODUCER;
    ...
    { c_producer * v6810; 
      list * v6811;
      v6810 = Generate.C_plus_plusPRODUCER;
  ...
  Generate.public_static->addMethod(list::domain(1,Generate._c_producer),Kernel._any,
  ...
  Generate.generate_system_file->addMethod(list::domain(2,Kernel._string,Kernel._list),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(generate_system_file_string,"generate_system_file_string"));
  
  Generate.create_loadModules->addMethod(list::domain(3,Kernel._string,Kernel._port,Kernel._list),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(create_loadModules_string,"create_loadModules_string"));
  ...
  { global_variable * v2072 = (Generate.FCLimit = (global_variable *) Core._global_variable->instantiate("FCLimit",Generate.it));
    (v2072->range = Kernel._integer);
    (v2072->value = 3);
    close_global_variable(v2072);
    } 
  ...
  { global_variable * v2072 = (Generate.bitvectorList = (global_variable *) Core._global_variable->instantiate("bitvectorList",Generate.it));
    (v2072->range = Kernel.emptySet);
  ...
  Generate.update->addMethod(list::domain(3,Generate._c_producer,Language._Update,Kernel._any),Kernel._any,
  ...
  Generate.pointer_cast->addMethod(list::domain(2,Generate._c_producer,Kernel._class),Kernel._void,
  	NEW_ALLOC,_function_(pointer_cast_c_producer,"pointer_cast_c_producer"));
