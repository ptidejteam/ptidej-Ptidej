...
// definition of the properties 
  ...
  { global_variable * _CL_obj = (Reader._stararrow_star = (global_variable *) Core._global_variable->instantiate("*arrow*",Reader.it));
  ...
  Reader.keyword_ask->addMethod(list::domain(1,Kernel._any),Kernel._any,
  ...
  { global_variable * _CL_obj = (Reader.StrictClaire2 = (global_variable *) Core._global_variable->instantiate("StrictClaire2",claire.it));
    (_CL_obj->range = Kernel._boolean);
    (_CL_obj->value = Kernel.ctrue);
    close_global_variable(_CL_obj);
    } 
  
  { global_variable * _CL_obj = (Reader.Declarations = (global_variable *) Core._global_variable->instantiate("Declarations",Reader.it));
    (_CL_obj->range = nth_class1(Kernel._set,Kernel._property));
    (_CL_obj->value = _oid_(set::alloc(Kernel._property,9,_oid_(Kernel.ABSTRACT),
      _oid_(Kernel.FINAL),
  ...
  { global_variable * _CL_obj = (Reader.LastExpRead = (global_variable *) Core._global_variable->instantiate("LastExpRead",Reader.it));
    (_CL_obj->range = Kernel._any);
    (_CL_obj->value = CNULL);
    close_global_variable(_CL_obj);
    } 
  ...
  Kernel.flush->addMethod(list::domain(1,Kernel._port),Kernel._any,
  	0,_function_(flush_port,"flush_port"));
  ...
  { global_variable * _CL_obj = (Reader.step_I = (global_variable *) Core._global_variable->instantiate("step!",Reader.it));
    (_CL_obj->range = Kernel.emptySet);
    (_CL_obj->value = _oid_(Kernel.step_I));
    close_global_variable(_CL_obj);
    } 
  
  { global_variable * _CL_obj = (Reader.get_stack = (global_variable *) Core._global_variable->instantiate("get_stack",Reader.it));
    (_CL_obj->range = Kernel.emptySet);
    (_CL_obj->value = _oid_(Core.get_stack));
    close_global_variable(_CL_obj);
    } 
  ...
  Core.spy->addMethod(list::domain(1,Kernel._listargs),Kernel._any,
  ...
  Reader.PRshow->addMethod(list::domain(1,Kernel._void),Kernel._any,
  ...
  { (Reader.PRdependent = (table *) Kernel._table->instantiate("PRdependent",Reader.it));
    ...
    (Reader.PRdependent->DEFAULT = _oid_(Kernel.emptySet));
    } 
  ...
  { (Reader.PRdependentOf = (table *) Kernel._table->instantiate("PRdependentOf",Reader.it));
    ...
    (Reader.PRdependentOf->DEFAULT = _oid_(Kernel.emptySet));
    } 
  ...
  Reader.PRdepends->addMethod(list::domain(2,Kernel._property,Kernel._property),Kernel._any,
