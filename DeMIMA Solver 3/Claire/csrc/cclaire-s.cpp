// --- System configuration file for "cclaire" , ["Thu Feb 13 21:07:05 2003\n"] ---
...
{ //module definitions 
  ...
  "d:\\claire\\v3.2\\src\\compile",list::alloc(Kernel._string,5,_string_("osystem"),
    _string_("otool"),
    _string_("ocall"),
    _string_("ocontrol"),
    _string_("odefine")));
  Generate.initModule("Generate",Compile.it,list::alloc(Kernel._module,2,_oid_(Optimize.it),_oid_(mClaire.it)),
  "d:\\claire\\v3.2\\src\\compile",list::alloc(Kernel._string,5,_string_("gsystem"),
    _string_("gexp"),
    _string_("gstat"),
    _string_("cgen"),
    _string_("copt")));
