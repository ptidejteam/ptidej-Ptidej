/***** CLAIRE Compilation of file Core.cl 
         [version 3.2.52 / safety 5] Sat Sep 14 18:02:44 2002 *****/
...
// definition of the properties 
  ...
  Core.about->addMethod(list::domain(1,Kernel._void),Kernel._any,
  	NEW_ALLOC,_function_(about_void,"about_void"));
  ...
  Core.erase->addMethod(list::domain(1,Kernel._table),Kernel._any,
  ...
  Core.reify->addMethod(list::domain(1,Kernel._listargs),Kernel._any,
  ...
  { global_variable * _CL_obj = (Core.claire_date = (global_variable *) Core._global_variable->instantiate("claire_date",claire.it));
    ...
    (_CL_obj->value = _string_("Sat Sep 14 18:02:43 2002\n"));
    close_global_variable(_CL_obj);
    } 
  ...
  Kernel.stat->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	0,_function_(claire_stat,"claire_stat"));
  
  Kernel.gensym->addMethod(list::domain(1,Kernel._void),Kernel._symbol,
  	NEW_ALLOC,_function_(gensym_void,"gensym_void"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Kernel._symbol),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE,_function_(self_print_symbol_Core,"self_print_symbol_Core"));
  
  Kernel.c_princ->addMethod(list::domain(1,Kernel._symbol),Kernel._any,
  	0,_function_(c_princ_symbol,"c_princ_symbol"));
  
  Kernel.gensym->addMethod(list::domain(1,Kernel._string),Kernel._symbol,
  	NEW_ALLOC,_function_(gensym_string,"gensym_string"));
  ...
  Kernel._dash->addMethod(list::domain(1,Kernel._integer),Kernel._integer,
  	0,_function_(ch_sign,"ch_sign"));
  
  Kernel.mod->addMethod(list::domain(2,Kernel._integer,Kernel._integer),Kernel._integer,
  ...
  Kernel.self_print->addFloatMethod(list::domain(1,Kernel._float),Kernel._any,
  	0,_function_(princ_float,"princ_float"),_function_(princ_float_,"princ_float_"));
  ...
  Kernel._inf_inf->addMethod(list::domain(2,Kernel._list,Kernel._integer),Kernel._list,
  ...
  Kernel.self_print->addMethod(list::domain(1,Kernel._array),Kernel._any,
  	NEW_ALLOC,_function_(self_print_array_Core,"self_print_array_Core"));
  
  Kernel.self_print->addMethod(list::domain(1,Kernel._char),Kernel._any,
  ...
  (Kernel.nth_get->addMethod(list::domain(2,Kernel._array,Kernel._integer),Kernel._any,
  	0,_function_(nth_get_array,"nth_get_array"))->typing = _oid_(_function_(nth_get_array_type,"nth_get_array_type")));
