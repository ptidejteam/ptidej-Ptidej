...
public class Composite2 extends Primitive {
	...
	protected void setUp()
		...
		if (Composite2.FoundSolutions == null) {
			...
			// Expected solutions.
			Composite2.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite2", codeLevelModel);
			Composite2.NumberOfExpectedSolutions = SolutionReader
					.getExpectedNumberOfSolutions("Composite2", codeLevelModel);

			// Solutions found.
			Composite2.FoundSolutions = this.testDesignPattern(Composite2.class,
	...
	public void testSolutions() {
		for (int i = 0; i < Composite2.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite2.ExpectedSolutions[i],
