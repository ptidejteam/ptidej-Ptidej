...
import ptidej.solver.claire.test.pattern.BadCompositionExample2;
import ptidej.solver.claire.test.pattern.BadCompositionPattern;

public final class BadComposition2Test extends Primitive {
	private Occurrence[] builtSolutions;

	public BadComposition2Test(final String name) {
		super(name);
	}
