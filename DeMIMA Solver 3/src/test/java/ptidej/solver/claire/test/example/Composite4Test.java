...
public class Composite4Test extends Primitive {
	...
	public Composite4Test(final String name) {
		super(name);
	}
	...
	protected void setUp()
		...
		if (Composite4Test.FoundSolutions == null) {
			...
			final ICodeLevelModel codeLevelModel = Factory.getInstance()
					.createCodeLevelModel("ptidej.example.composite4");
			try {
				codeLevelModel
						.create(new CompleteClassFileCreator(new String[] {
								"../DeMIMA/target/test-classes/ptidej/example/composite4/" }));
			}
			...
			// Expected solutions.
			Composite4Test.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite4", codeLevelModel);
			Composite4Test.NumberOfExpectedSolutions = SolutionReader
					.getExpectedNumberOfSolutions("Composite4", codeLevelModel);

			// Solutions found.
			Composite4Test.FoundSolutions = this.testDesignPattern(Composite4Test.class,
	...
	public void testNumberOfSolutions() {
		Assert.assertEquals("Number of solutions",
				Composite4Test.NumberOfExpectedSolutions,
				Composite4Test.FoundSolutions.length);
	}

	public void testSolutions() {
		for (int i = 0; i < Composite4Test.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite4Test.ExpectedSolutions[i],
					Composite4Test.FoundSolutions[i]);
		}
	}
