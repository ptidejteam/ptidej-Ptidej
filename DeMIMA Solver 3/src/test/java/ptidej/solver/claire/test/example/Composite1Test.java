...
public class Composite1Test extends Primitive {
	...
	protected void setUp()
		...
		if (Composite1Test.FoundSolutions == null) {
			...
			try {
				...
				// Expected solutions.
				Composite1Test.ExpectedSolutions = SolutionReader
						.getExpectedSolutions("Composite1", idiomLevelModel);
				Composite1Test.NumberOfExpectedSolutions = SolutionReader
						.getExpectedNumberOfSolutions("Composite1",
								idiomLevelModel);

				// Solutions found.
				Composite1Test.FoundSolutions = this.testDesignPattern(
						Composite1Test.class, Primitive.ALL_SOLUTIONS,
	...
	public void testNumberOfSolutions() {
		Assert.assertEquals("Number of solutions",
				Composite1Test.NumberOfExpectedSolutions,
				Composite1Test.FoundSolutions.length);
	}

	public void testSolutions() {
		for (int i = 0; i < Composite1Test.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite1Test.ExpectedSolutions[i],
					Composite1Test.FoundSolutions[i]);
		}
	}
