...
public class Composite5 extends Primitive {
	...
	protected void setUp()
		...
		if (Composite5.FoundSolutions == null) {
			...
			// Expected solutions.
			Composite5.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite5", codeLevelModel);
			Composite5.NumberOfExpectedSolutions = SolutionReader
					.getExpectedNumberOfSolutions("Composite5", codeLevelModel);

			// Solutions found.
			Composite5.FoundSolutions = this.testDesignPattern(Composite4.class,
	...
	public void testSolutions() {
		for (int i = 0; i < Composite5.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite5.ExpectedSolutions[i],
