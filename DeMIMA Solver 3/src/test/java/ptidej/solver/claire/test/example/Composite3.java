...
public class Composite3 extends Primitive {
	...
	protected void setUp()
		...
		if (Composite3.FoundSolutions == null) {
			...
			// Expected solutions.
			Composite3.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite3", codeLevelModel);
			Composite3.NumberOfExpectedSolutions = SolutionReader
					.getExpectedNumberOfSolutions("Composite3", codeLevelModel);

			// Solutions found.
			Composite3.FoundSolutions = this.testDesignPattern(Composite3.class,
	...
	public void testSolutions() {
		for (int i = 0; i < Composite3.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite3.ExpectedSolutions[i],
