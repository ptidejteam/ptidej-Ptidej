...
public final class UsePattern extends TestMotifModel {
	...
	public UsePattern() {
		final IClass caller =
			this.getFactory().createClass(UsePattern.CALLER, UsePattern.CALLER);
		final IClass callee =
			this.getFactory().createClass(UsePattern.CALLEE, UsePattern.CALLEE);
