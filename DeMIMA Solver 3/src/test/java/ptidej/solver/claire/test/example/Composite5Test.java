...
public class Composite5Test extends Primitive {
	...
	public Composite5Test(final String name) {
		super(name);
	}
	...
	protected void setUp()
		...
		if (Composite5Test.FoundSolutions == null) {
			...
			final ICodeLevelModel codeLevelModel = Factory.getInstance()
					.createCodeLevelModel("ptidej.example.composite5");
			try {
				codeLevelModel
						.create(new CompleteClassFileCreator(new String[] {
								"../DeMIMA/target/test-classes/ptidej/example/composite5/" }));
			}
			...
			// Expected solutions.
			Composite5Test.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite5", codeLevelModel);
			Composite5Test.NumberOfExpectedSolutions = SolutionReader
					.getExpectedNumberOfSolutions("Composite5", codeLevelModel);

			// Solutions found.
			Composite5Test.FoundSolutions = this.testDesignPattern(Composite4Test.class,
	...
	public void testNumberOfSolutions() {
		Assert.assertEquals("Number of solutions",
				Composite5Test.NumberOfExpectedSolutions,
				Composite5Test.FoundSolutions.length);
	}

	public void testSolutions() {
		for (int i = 0; i < Composite5Test.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", Composite5Test.ExpectedSolutions[i],
					Composite5Test.FoundSolutions[i]);
		}
	}
