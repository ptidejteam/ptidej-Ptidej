...
public final class ContainerAggregation extends Association {
	...
	protected ISymbol getOriginSymbol() {
		return this.getPrimitiveFactory().createAggregationSymbol(
	...
	public int getVisibilityDisplay() {
		return IVisibility.CONTAINER_AGGREGATION_DISPLAY_ELEMENTS;
	}
	public int getVisibilityName() {
		return IVisibility.CONTAINER_AGGREGATION_NAMES;
	}
}
