...
public class MI_InstanceInstanceTest extends TestCase {
	...
	public void testINSTANCE_INSTANCE_1() {
		...
		final String[] javaFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/Association_INSTANCE_INSTANCE_1.java" };
		...
		final String[] classFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse) Tests/bin/padl/example/relationship/Association_INSTANCE_INSTANCE_1.class" };
	...
	public void testINSTANCE_INSTANCE_2() {
		...
		final String[] javaFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/A.java",
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/Association_INSTANCE_INSTANCE_2.java" };
		final String classPathEntry = "";
		final ICodeLevelModel javaModel =
			Utils.createCompleteJavaFilesPadlModel(
				"",
		...
		final String[] classFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse) Tests/bin/padl/example/relationship/A.class",
					"../PADL Creator JavaFile (Eclipse) Tests/bin/padl/example/relationship/Association_INSTANCE_INSTANCE_2.class" };
		final ICodeLevelModel classModel =
			Utils.createCompleteJavaClassesPadlModel("", classFiles);
