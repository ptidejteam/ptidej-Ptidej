...
public class MI_ClassInstanceTest extends TestCase {
	...
	public void testCLASS_INSTANCE_1() {
		...
		final String[] javaFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse)/src/test/java/padl/example/relationship/Association_CLASS_INSTANCE_1.java" };
		...
		final String[] classFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse)/target/test-classes/padl/example/relationship/Association_CLASS_INSTANCE_1.class" };
	...
	public void testCLASS_INSTANCE_2() {
		...
		final String[] javaFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse)/src/test/java/padl/example/relationship/A.java",
					"../PADL Creator JavaFile (Eclipse)/src/test/java/padl/example/relationship/Association_CLASS_INSTANCE_2.java" };
		final String classPathEntry = "";
		final ICodeLevelModel javaModel =
			Utils.createCompleteJavaFilesPadlModel(
				"",
		...
		final String[] classFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse)/target/test-classes/padl/example/relationship/A.class",
					"../PADL Creator JavaFile (Eclipse)/target/test-classes/padl/example/relationship/Association_CLASS_INSTANCE_2.class" };
		final ICodeLevelModel classModel =
			Utils.createCompleteJavaClassesPadlModel("", classFiles);
