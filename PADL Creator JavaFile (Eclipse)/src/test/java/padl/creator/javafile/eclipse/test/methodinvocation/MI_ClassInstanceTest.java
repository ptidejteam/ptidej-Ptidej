...
public class MI_ClassInstanceTest extends TestCase {
	...
	public void testCLASS_INSTANCE_1() {
		...
		final String[] javaFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/Association_CLASS_INSTANCE_1.java" };
	...
	public void testCLASS_INSTANCE_2() {
		...
		final String[] javaFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/A.java",
					"../PADL Creator JavaFile (Eclipse)/src/main/java/padl/example/relationship/Association_CLASS_INSTANCE_2.java" };
		final String classPathEntry = "";
		final ICodeLevelModel javaModel =
			Utils.createCompleteJavaFilesPadlModel(
				"",
