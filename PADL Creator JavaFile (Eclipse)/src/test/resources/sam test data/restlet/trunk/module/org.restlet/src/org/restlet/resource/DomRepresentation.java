...
public class DomRepresentation extends OutputRepresentation
{
	...
	public DomRepresentation(MediaType mediaType) throws IOException
	{
		...
		try
		{
			this.dom = DocumentBuilderFactory.getDeclaredConstructor().newInstance().newDocumentBuilder()
					.newDocument();
		}
			...
			throws IOException
	{
		...
		try
		{
			this.dom = DocumentBuilderFactory.getDeclaredConstructor().newInstance().newDocumentBuilder().parse(
	...
	public void write(OutputStream outputStream) throws IOException
	{
		try
		{
			TransformerFactory.getDeclaredConstructor().newInstance().newTransformer().transform(
