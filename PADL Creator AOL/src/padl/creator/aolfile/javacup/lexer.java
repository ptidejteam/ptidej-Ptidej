...
public class lexer {
	...
	protected static Symbol do_code_string() throws java.io.IOException {
		...
		while (!(lexer.next_char == ':' && lexer.next_char2 == '}')) {
			...
			result.append(Character.valueOf((char) lexer.next_char));
			lexer.advance();
		}
	...
	protected static int find_single_char(final int ch) {
		...
		result = (Integer) lexer.char_symbols.get(Integer.valueOf((char) ch));
		if (result == null) {
			return -1;
		}
		else {
	...
	public static void init() throws java.io.IOException {
		...
		lexer.keywords.put("package", Integer.valueOf(sym.PACKAGE));
		lexer.keywords.put("import", Integer.valueOf(sym.IMPORT));
		lexer.keywords.put("code", Integer.valueOf(sym.CODE));
		lexer.keywords.put("action", Integer.valueOf(sym.ACTION));
		lexer.keywords.put("parser", Integer.valueOf(sym.PARSER));
		lexer.keywords.put("terminal", Integer.valueOf(sym.TERMINAL));
		lexer.keywords.put("non", Integer.valueOf(sym.NON));
		lexer.keywords.put("nonterminal", Integer.valueOf(sym.NONTERMINAL));// [CSA]
		lexer.keywords.put("init", Integer.valueOf(sym.INIT));
		lexer.keywords.put("scan", Integer.valueOf(sym.SCAN));
		lexer.keywords.put("with", Integer.valueOf(sym.WITH));
		lexer.keywords.put("start", Integer.valueOf(sym.START));
		lexer.keywords.put("precedence", Integer.valueOf(sym.PRECEDENCE));
		lexer.keywords.put("left", Integer.valueOf(sym.LEFT));
		lexer.keywords.put("right", Integer.valueOf(sym.RIGHT));
		lexer.keywords.put("nonassoc", Integer.valueOf(sym.NONASSOC));

		/* set up the table of single character symbols */
		lexer.char_symbols.put(Integer.valueOf(';'), Integer.valueOf(sym.SEMI));
		lexer.char_symbols.put(Integer.valueOf(','), Integer.valueOf(sym.COMMA));
		lexer.char_symbols.put(Integer.valueOf('*'), Integer.valueOf(sym.STAR));
		lexer.char_symbols.put(Integer.valueOf('.'), Integer.valueOf(sym.DOT));
		lexer.char_symbols.put(Integer.valueOf('|'), Integer.valueOf(sym.BAR));
		lexer.char_symbols.put(Integer.valueOf('['), Integer.valueOf(sym.LBRACK));
		lexer.char_symbols.put(Integer.valueOf(']'), Integer.valueOf(sym.RBRACK));
	...
	protected static Symbol real_next_token() throws java.io.IOException {
		...
		for (;;) {
			...
			lexer.emit_warn("Unrecognized character '"
					+ Character.valueOf((char) lexer.next_char) + "'("
