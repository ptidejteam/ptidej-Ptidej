...
import padl.creator.aolfile.javacup.runtime.lr_parser;
...
class CUP$parser$actions {
	...
	protected void add_precedence(final String term) {
		if (term == null) {
			...
			if (sp == null) {
				...
				final padl.creator.aolfile.javacup.symbol sym = sp.the_symbol();
	...
	public final padl.creator.aolfile.javacup.runtime.Symbol CUP$parser$do_action(
		final int CUP$parser$act_num,
		final padl.creator.aolfile.javacup.runtime.lr_parser CUP$parser$parser,
		final java.util.Stack CUP$parser$stack,
		final int CUP$parser$top) throws java.lang.Exception {
		/* Symbol object for return from actions */
		padl.creator.aolfile.javacup.runtime.Symbol CUP$parser$result;
		...
		switch (CUP$parser$act_num) {
			...
			case 106 : // empty ::= 
				{
					...
					CUP$parser$result =
						new padl.creator.aolfile.javacup.runtime.Symbol(
							29/*empty*/,
							((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
			...
			case 86 : // robust_id ::= ID 
				{
					String RESULT = null;
					final int the_idleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int the_idright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
					final String the_id =
						(String) ((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
			...
			case 80 : // new_non_term_id ::= ID 
				{
					final Object RESULT = null;
					final int non_term_idleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int non_term_idright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
			...
			case 79 : // new_term_id ::= ID 
				{
					final Object RESULT = null;
					final int term_idleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int term_idright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
			...
			case 73 : // multipart_id ::= multipart_id DOT robust_id 
				{
					final Object RESULT = null;
					final int another_idleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int another_idright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
			...
			case 70 : // prod_part ::= CODE_STRING 
				{
					final Object RESULT = null;
					final int code_strleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int code_strright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
			...
			case 65 : // rhs ::= prod_part_list PERCENT_PREC term_id 
				{
					final Object RESULT = null;
					final int term_nameleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).left;
					final int term_nameright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 0)).right;
					...
					padl.creator.aolfile.javacup.symbol sym = null;
					if (this.lhs_nt != null) {
			...
			case 62 : // production ::= error NT$13 SEMI 
				{
					...
					if (((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
						.elementAt(CUP$parser$top - 1)).value != null) {
						RESULT =
							(Object) ((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
								.elementAt(CUP$parser$top - 1)).value;
					}
			...
			case 60 : // production ::= nt_id NT$11 COLON_COLON_EQUALS NT$12 rhs_list SEMI 
				{
					...
					final int lhs_idleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 5)).left;
					final int lhs_idright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
			...
			case 54 : // start_spec ::= START WITH nt_id NT$10 SEMI 
				{
					...
					final int start_nameleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 2)).left;
					final int start_nameright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 2)).right;
			...
			case 20 : // scan_code ::= SCAN WITH CODE_STRING opt_semi 
				{
					final Object RESULT = null;
					final int user_codeleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 1)).left;
					final int user_coderight =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 1)).right;
			...
			case 0 : // $START ::= spec EOF 
				{
					Object RESULT = null;
					final int start_valleft =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 1)).left;
					final int start_valright =
						((padl.creator.aolfile.javacup.runtime.Symbol) CUP$parser$stack
							.elementAt(CUP$parser$top - 1)).right;
...
/** CUP v0.10k generated parser.
  ...
  */
public class parser extends padl.creator.aolfile.javacup.runtime.lr_parser {
	...
	public parser(final padl.creator.aolfile.javacup.runtime.Scanner s) {
		super(s);
	}
	...
	public padl.creator.aolfile.javacup.runtime.Symbol do_action(
		final int act_num,
		final padl.creator.aolfile.javacup.runtime.lr_parser parser,
	...
	public padl.creator.aolfile.javacup.runtime.Symbol scan()
			throws java.lang.Exception {
