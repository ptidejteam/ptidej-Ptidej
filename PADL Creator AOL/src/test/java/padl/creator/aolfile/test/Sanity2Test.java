 ...
 * @since  2006/11/28
 */
public class Sanity2Test extends TestCase {
	private static ICodeLevelModel CodeLevelModel;
	private static IIdiomLevelModel IdiomLevelModel;

	public Sanity2Test(final String name) {
		super(name);
	}
	public void setUp() {
		if (Sanity2Test.CodeLevelModel == null) {
			Sanity2Test.CodeLevelModel =
			...
			aolCreator.create(Sanity2Test.CodeLevelModel, true);
			try {
				Sanity2Test.IdiomLevelModel =
					(IIdiomLevelModel) new AACRelationshipsAnalysis()
						.invoke(Sanity2Test.CodeLevelModel);
			}
	...
	public void testClasses() {
		Assert.assertEquals("Number of classes", 3, Sanity2Test.IdiomLevelModel
