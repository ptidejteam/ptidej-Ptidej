...
public class AIDTest extends TestCase {
	...
	private static final String root =
		"../POM/target/test-classes/Metric Specific for Java/bin/pom/test/rsc/specific/testAID/";
	public AIDTest(String name) {
		super(name);
	}
	protected void setUp() throws Exception {
		super.setUp();
		if (AIDTest.model == null) {
			AIDTest.model =
				Factory.getInstance().createCodeLevelModel("Test.TestMetrics");
			AIDTest.model.create(new CompleteClassFileCreator(
				new String[] { root }));

			AIDTest.metrics = MetricsRepository.getInstance();
		}
	}
	public void testRef() {
	...
	public void testAncestorExtend01() {
		final IFirstClassEntity firstClassEntity =
			(IFirstClassEntity) AIDTest.model
