 ...
 *
 */
public class MethodPrimitivesTest extends junit.framework.TestCase {
	private final String root = "../POM/target/test-classes/Metric Specific for Java/bin/pom/test/rsc/";
	...
	public MethodPrimitivesTest(final String aName) {
		super(aName);
	}
