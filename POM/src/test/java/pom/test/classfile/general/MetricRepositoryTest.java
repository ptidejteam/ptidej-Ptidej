 ...
 *  
 */
public class MetricRepositoryTest extends TestCase {
	public MetricRepositoryTest(String aName) {
		super(aName);
	}
	...
	protected void setUp() throws Exception {
		super.setUp();
		if (MetricRepositoryTest.Model == null) {
			MetricRepositoryTest.Model = Factory.getInstance()
					.createCodeLevelModel("Test.TestMetrics");
			MetricRepositoryTest.Model.create(new CompleteClassFileCreator(
					new String[] { MetricRepositoryTest.Root }));
			MetricRepositoryTest.Metrics = MetricsRepository.getInstance();
		}
	}

	public void testUnarymetricList() {
		Assert.assertNotNull(MetricRepositoryTest.Metrics.getUnaryMetrics());
	}
	...
	public void testRuntimeDeprecation() {
		...
		final double result = new USELESS().compute(MetricRepositoryTest.Model,
				MetricRepositoryTest.Model
