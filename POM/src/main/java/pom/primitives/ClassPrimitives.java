...
/**
 * @author Farouk ZAIDI, Rushin Dipak Makwana
 * @since 2004/02/01
 *
...
public class ClassPrimitives extends Primitives {
    ...
    private final List ancestorsMethods(final IFirstClassEntity firstClassEntity) {
        ...
        for (final Iterator iterAncestorEntity = ancestors.iterator(); iterAncestorEntity.hasNext(); ) {
            ...
            for (final Iterator iteratorOnElements = nextAncestor.getIteratorOnConstituents(); iteratorOnElements.hasNext(); ) {
    ...
    public final List listOfAllMethods(final IFirstClassEntity firstClassEntity) {
        ...
        while (iteratorOnEntities.hasNext()) {
            ...
            while (iteratorOnElements.hasNext()) {
                final IConstituent constituent = (IConstituent) iteratorOnElements.next();
    ...
    public final Collection listOfInheritedMethods(final IFirstClassEntity firstClassEntity) {
        final Collection list = this.operators.difference(ancestorsMethods(firstClassEntity), listOfDeclaredMethods(firstClassEntity));
        return list;
    }
    ...
    public final Collection listOfNewMethods(final IFirstClassEntity firstClassEntity) {
        return this.operators.difference(this.listOfDeclaredMethods(firstClassEntity), this.ancestorsMethods(firstClassEntity));
    }
    /**
    ...
    public final Collection listOfOverriddenAndConcreteMethods(final IFirstClassEntity firstClassEntity) {
        final Collection list = this.operators.difference(this.listOfAllMethods(firstClassEntity), this.listOfInheritedAndAbstractMethods(firstClassEntity));
        return list;
    }
