...
class CLexGen {
	...
	CLexGen(final String filename) throws java.io.FileNotFoundException,
		...
		this.m_tokens.put(Character.valueOf('$'), Integer.valueOf(CLexGen.AT_EOL));
		this.m_tokens.put(Character.valueOf('('), Integer.valueOf(CLexGen.OPEN_PAREN));
		this.m_tokens.put(Character.valueOf(')'), Integer.valueOf(CLexGen.CLOSE_PAREN));
		this.m_tokens.put(Character.valueOf('*'), Integer.valueOf(CLexGen.CLOSURE));
		this.m_tokens.put(Character.valueOf('+'), Integer.valueOf(CLexGen.PLUS_CLOSE));
		this.m_tokens.put(Character.valueOf('-'), Integer.valueOf(CLexGen.DASH));
		this.m_tokens.put(Character.valueOf('.'), Integer.valueOf(CLexGen.ANY));
		this.m_tokens.put(Character.valueOf('?'), Integer.valueOf(CLexGen.OPTIONAL));
		this.m_tokens.put(Character.valueOf('['), Integer.valueOf(CLexGen.CCL_START));
		this.m_tokens.put(Character.valueOf(']'), Integer.valueOf(CLexGen.CCL_END));
		this.m_tokens.put(Character.valueOf('^'), Integer.valueOf(CLexGen.AT_BOL));
		this.m_tokens.put(Character.valueOf('{'), Integer.valueOf(CLexGen.OPEN_CURLY));
		this.m_tokens.put(Character.valueOf('|'), Integer.valueOf(CLexGen.OR));
		this.m_tokens.put(Character.valueOf('}'), Integer.valueOf(CLexGen.CLOSE_CURLY));
			...
			for (int i = 0; i < this.ccls.length; i++) {
				if (clsA.get(this.ccls[i])) {
					if (nfa.m_edge == i || nfa.m_edge == CNfa.CCL
						...
						final Integer split = Integer.valueOf(this.ccls[i]);
