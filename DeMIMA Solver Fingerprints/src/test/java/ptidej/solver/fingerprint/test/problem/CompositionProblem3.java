 ...
 * @since  2004/09/05 
 */
public final class CompositionProblem3 {
	...
	public static Problem getProblem(final List allEntities) {
		...
		final Variable aggregate =
			new Variable(pb, CompositionProblem3.AGGREGATE, true, aggregateList);
		final Variable aggregated =
			new Variable(pb, CompositionProblem3.AGGREGATED, true, aggregatedList);
