...
public class HeaderUtils
{
	 ...
	 * @param source The unquoted source string. 
	 * @param destination The destination to append to.
	 * @throws IOException
	 */
	public static Appendable appendQuote(CharSequence source, Appendable destination)
			throws IOException
	{
		destination.append('"');
	 ...
	 * @throws IOException
	 */
	public static Appendable appendUriEncoded(CharSequence source, Appendable destination)
			throws IOException
	{
	 ...
	 * @param nameToken The product name token.
	 * @param versionToken The product version token.
	 * @param destination The appendable destination;
	 * @throws IOException
	 */
	public static void formatProduct(CharSequence nameToken, CharSequence versionToken,
	...
	public static boolean isToken(CharSequence token)
	{
		...
		{
			if (!isTokenChar(token.charAt(i))) return false;
		}
