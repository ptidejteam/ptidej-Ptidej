...
public class MI_InstanceInstanceTest extends TestCase {
	...
	public void testINSTANCE_INSTANCE_1() {
		...
		final String[] javaFiles =
			new String[] {
					...
					"../PADL Creator JavaFile (Eclipse) Tests/src/padl/example/relationship/Association_INSTANCE_INSTANCE_1.java" };
	...
	public void testINSTANCE_INSTANCE_2() {
		...
		final String[] javaFiles =
			new String[] {
					"../PADL Creator JavaFile (Eclipse) Tests/src/padl/example/relationship/A.java",
					"../PADL Creator JavaFile (Eclipse) Tests/src/padl/example/relationship/Association_INSTANCE_INSTANCE_2.java" };
		final String classPathEntry = "";
		final ICodeLevelModel javaModel =
			Utils.createCompleteJavaFilesPadlModel(
				"",
