...
public MappingLexer(LexerSharedInputState state) {
	...
	this.literals.put(new ANTLRHashString("Columns", this), Integer.valueOf(7));
	this.literals.put(new ANTLRHashString("Data", this), Integer.valueOf(12));
	this.literals.put(new ANTLRHashString("Chapters", this), Integer.valueOf(10));
	this.literals.put(new ANTLRHashString("Rows", this), Integer.valueOf(8));
	this.literals.put(new ANTLRHashString("Sections", this), Integer.valueOf(11));
	this.literals.put(new ANTLRHashString("FormattedData", this), Integer.valueOf(13));
	this.literals.put(new ANTLRHashString("Axis", this), Integer.valueOf(4));
	this.literals.put(new ANTLRHashString("Pages", this), Integer.valueOf(9));
}
