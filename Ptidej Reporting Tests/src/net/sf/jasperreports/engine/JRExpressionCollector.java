 ...
 * @version $Id: JRExpressionCollector.java,v 1.1 2008/09/29 16:20:42 guehene Exp $
 */
public class JRExpressionCollector
{
	...
	protected static class GeneratedIds
	{
		...
		public JRExpression put(Integer id, JRExpression expression)
		{
			...
			return (JRExpression) this.ids.put(id, expression);
		}
		...
		public Integer nextId()
		{
			...
			{
				id = Integer.valueOf(++this.nextId);
			}
			return id;
		}
		...
		{
			return (JRExpression) this.ids.get(Integer.valueOf(id));
		}
	}
	...
	{
		this.crosstabIds.put(crosstab, Integer.valueOf(this.crosstabIds.size()));
	}
