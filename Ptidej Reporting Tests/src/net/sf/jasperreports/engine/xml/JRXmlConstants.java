 ...
 * @version $Id: JRXmlConstants.java,v 1.1 2008/09/29 16:19:52 guehene Exp $
 */
public class JRXmlConstants
{
	...
	public static Map  getScaleTypeMap(){
		if( scaleTypeMap == null ){
			...
			scaleTypeMap.put( SCALE_ON_BOTH_AXES, Integer.valueOf( XYBubbleRenderer.SCALE_ON_BOTH_AXES ));
			scaleTypeMap.put( SCALE_ON_DOMAIN_AXIS, Integer.valueOf( XYBubbleRenderer.SCALE_ON_DOMAIN_AXIS ));
			scaleTypeMap.put( SCALE_ON_RANGE_AXIS, Integer.valueOf( XYBubbleRenderer.SCALE_ON_RANGE_AXIS ));
			scaleTypeMap.put( Integer.valueOf( XYBubbleRenderer.SCALE_ON_BOTH_AXES ), SCALE_ON_BOTH_AXES );
			scaleTypeMap.put( Integer.valueOf( XYBubbleRenderer.SCALE_ON_DOMAIN_AXIS ), SCALE_ON_DOMAIN_AXIS );
			scaleTypeMap.put( Integer.valueOf( XYBubbleRenderer.SCALE_ON_RANGE_AXIS ), SCALE_ON_RANGE_AXIS );
		}
