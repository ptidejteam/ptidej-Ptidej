 ...
 * @version $Id: JRHibernateAbstractDataSource.java,v 1.1 2008/09/29 16:22:08 guehene Exp $
 */
public abstract class JRHibernateAbstractDataSource implements JRDataSource
{
	...
	{
		FieldReader reader = (FieldReader) this.fieldReaders.get(jrField.getName());
		if (reader == null)
		{
