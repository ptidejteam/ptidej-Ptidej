 ...
 * @version $Id: JRSortableDataSource.java,v 1.1 2008/09/29 16:22:08 guehene Exp $
 */
public class JRSortableDataSource implements JRRewindableDataSource
{
	...
	public JRSortableDataSource(JRDataSource ds, JRField[] fields, JRSortField[] sortFields, Locale locale) throws JRException
	{
		...
		{
			this.fieldIndexMap.put(fields[i].getName(), Integer.valueOf(i));
		}
		...
		for(int i = 0; i < sortFields.length; i++)
		{
			...
			sortIndexes[i] = ((Integer)this.fieldIndexMap.get(sortField.getName())).intValue();
