 ...
 * @version $Id: JRReportCompileData.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 * 
...
public class JRReportCompileData implements Serializable
{
	...
	{
		this.datasetCompileData = new HashMap();
		this.crosstabCompileData = new HashMap();
	}
	...
	{
		this.crosstabCompileData.put(Integer.valueOf(crosstabId), compileData);
	}
	...
	{
		Serializable compileData = (Serializable) this.crosstabCompileData.get(Integer.valueOf(crosstab.getId()));
		if (compileData == null)
		{
