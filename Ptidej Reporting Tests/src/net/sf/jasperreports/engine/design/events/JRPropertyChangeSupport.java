 ...
 * @version $Id: JRPropertyChangeSupport.java,v 1.1 2008/09/29 16:22:07 guehene Exp $
 */
public class JRPropertyChangeSupport extends PropertyChangeSupport
{
	...
	{
		firePropertyChange(new CollectionElementAddedEvent(this.sourceBean, propertyName, 
	...
	{
		firePropertyChange(new CollectionElementRemovedEvent(this.sourceBean, propertyName, 
