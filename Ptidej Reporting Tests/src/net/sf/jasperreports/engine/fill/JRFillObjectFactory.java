 ...
 * @version $Id: JRFillObjectFactory.java,v 1.1 2008/09/29 16:20:01 guehene Exp $
 */
...
//	private JRFont defaultFont = null;
	...
	protected static class StylesList
	{
		...
		public JRStyle getStyle(String name)
		{
			...
			return idx == null ? null : (JRStyle) this.styles.get(idx.intValue());
		}
		
		public void addStyle(JRStyle style)
		{
			this.styles.add(style);
			this.stylesIdx.put(style.getName(), Integer.valueOf(this.styles.size() - 1));
		}
