 ...
 * @version $Id: JRPdfExporterParameter.java,v 1.1 2008/09/29 16:20:45 guehene Exp $
 */
public class JRPdfExporterParameter extends JRExporterParameter
{


	public static Character PDF_VERSION_1_2 = Character.valueOf('2');  // Not using iText constants in order not to depend on the library version
	public static Character PDF_VERSION_1_3 = Character.valueOf('3');
	public static Character PDF_VERSION_1_4 = Character.valueOf('4');
	public static Character PDF_VERSION_1_5 = Character.valueOf('5');
	public static Character PDF_VERSION_1_6 = Character.valueOf('6');
