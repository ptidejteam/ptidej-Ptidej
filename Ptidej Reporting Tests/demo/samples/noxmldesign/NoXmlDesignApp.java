 ...
 * @version $Id: NoXmlDesignApp.java,v 1.1 2008/09/29 16:22:21 guehene Exp $
 */
public class NoXmlDesignApp
{
	...
	private static JasperDesign getJasperDesign() throws JRException
	{
		...
		expression.setText("($V{CityNumber} != null)?(Integer.valueOf($V{CityNumber}.intValue() + 1)):(Integer.valueOf(1))");
