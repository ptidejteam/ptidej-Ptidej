 ...
 * @version $Id: I18nApp.java,v 1.1 2008/09/29 16:22:00 guehene Exp $
 */
	...
	public static void main(String[] args)
	{
		...
		try
		{
			if (TASK_FILL.equals(taskName))
			{
				...
				if (locale != null)
				{
//					Object[] aw = new Object[] {Double.valueOf(1000000.45), "$", "Ferrari", Integer.valueOf(20),Integer.valueOf(88)};
					Map parameters = new HashMap();
					parameters.put("number", Double.valueOf(1234567 + Math.random()));
