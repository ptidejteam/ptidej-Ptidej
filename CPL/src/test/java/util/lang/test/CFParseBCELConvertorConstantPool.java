 ...
 * @since	2006/07/27
 */
public class CFParseBCELConvertorConstantPool {
	...
	public static ClassFile convertClassFile(final JavaClass aJavaClass) {
		...
		CFParseBCELConvertorConstantPool.convertConstantPool(aJavaClass,
				currentClass.getCP());
		CFParseBCELConvertorConstantPool.addInterfaces(currentClass,
				aJavaClass);
		CFParseBCELConvertorConstantPool.addMethods(currentClass, aJavaClass);
		CFParseBCELConvertorConstantPool.addFields(currentClass, aJavaClass);
	...
	private static com.ibm.toad.cfparse.ConstantPool convertConstantPool(
		...
		for (int index = 1; index < constants.length; index++) {
			...
			if (constant instanceof ConstantClass) {
				...
				final boolean found = CFParseBCELConvertorConstantPool
						.searchFor(cfparseCP, className,
