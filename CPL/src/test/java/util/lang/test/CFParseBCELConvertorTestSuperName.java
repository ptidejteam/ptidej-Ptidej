...
import util.lang.CFParseBCELConvertorSuperName;

class CFParseBCELConvertorTestSuperName {
	...
	@Test
	void testGetSuperName() {
		assertEquals(this.classFile_CFParse_Original.getSuperName(), this.classFile_CFParse_Converted.getSuperName());
	}
	@Test
	void testGetSourceFileName() {
		assertEquals(this.classFile_CFParse_Original.getSourceFilename(), this.classFile_CFParse_Converted.getSourceFilename());
	}
