 ...
 * @since	2006/07/27
 */
public class CFParseBCELConverter_CP {
	...
	public static ClassFile convertClassFile(final JavaClass aJavaClass) {
		...
		CFParseBCELConverter_CP.convertConstantPool(aJavaClass,
				currentClass.getCP());

		CFParseBCELConverter_CP.addInterfaces(currentClass, aJavaClass);
		CFParseBCELConverter_CP.addMethods(currentClass, aJavaClass);
		CFParseBCELConverter_CP.addFields(currentClass, aJavaClass);
	...
	private static com.ibm.toad.cfparse.ConstantPool convertConstantPool(
		...
		for (int index = 1; index < constants.length; index++) {
			...
			if (constant instanceof ConstantClass) {
				...
				final boolean found = CFParseBCELConverter_CP.searchFor(cfparseCP,
