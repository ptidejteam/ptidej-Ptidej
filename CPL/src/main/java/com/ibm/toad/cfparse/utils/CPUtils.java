...
public final class CPUtils {
	public static final String[] d_typeNames = new String[] { "null0",
			...
			if (var3 == -1) {
				...
				if (var4.indexOf(" ") != -1) {
					...
					if (var7 == -1) {
						...
						for (int var9 = var8.indexOf(
								","); var9 != -1; var9 = var8.indexOf(",")) {
							String var10 = var8.substring(0, var9).trim();
							java2descriptor(var10, var6);
							var8 = var8.substring(var9 + 1, var8.length())
									.trim();
						}
	...
	public static int countArgs(ConstantPool var0, int var1) {
		...
		if (var2 != 10 && var2 != 11 && var2 != 9) {
			...
			Utf8Entry var3 = (Utf8Entry) var0.get(
					var0.get(var0.get(var1).getIndices()[1]).getIndices()[1]);
	...
	public static int countRet(ConstantPool var0, int var1) {
		...
		if (var2 != 10) {
			...
			String var3 = ((Utf8Entry) var0.get(
					var0.get(var0.get(var1).getIndices()[1]).getIndices()[1]))
					.getAsString();
	...
	public static String[] getMethodParams(String var0) {
		...
		if (var0.charAt(var1) != '(') {
			...
			for (int var7 = var4.indexOf(" "); var7 != -1; var7 = var4
					.indexOf(" ", var6)) {
	...
	public static String nameForType(int var0) {
		return var0 >= 0 && var0 < d_typeNames.length ? d_typeNames[var0]
				: null;
	}
	...
	public static String method2java(String var0) {
		...
		if (var0.charAt(var1) != '(') {
			ProxyConsole.getInstance().errorOutput()
					.println("Error: couldn't translate <" + var0
			...
			int var4;
			for (var4 = var1 + 1; var4 < var0
					.length(); var4 = descriptor2java(var0, var4, var2)) {
				if (var0.charAt(var4) == ')') {
					var2.append(")");
					++var4;
					break;
	...
	public static int descriptor2java(String var0, int var1,
			StringBuffer var2) {
		String var3;
		...
		label37: switch (var0.charAt(var1)) {
		case 'B':
			var2.append("byte");
			break;
		case 'C':
