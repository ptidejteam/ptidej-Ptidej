...
public final class InnerClassesAttrInfo extends AttrInfo {
	...
	public String toString() {
		StringBuffer var1 = new StringBuffer(this.sindent() + "Attribute: "
				+ super.d_cp.getAsString(super.d_idxName) + ": \n");

		for (int var2 = 0; var2 < this.d_innerClasses.length; var1
				.append("\n")) {
			...
			var1.append(this.sindent() + var7 + Access.getAsString(var6)
					+ super.d_cp.getAsJava(var3));
			if (var4 != 0) {
