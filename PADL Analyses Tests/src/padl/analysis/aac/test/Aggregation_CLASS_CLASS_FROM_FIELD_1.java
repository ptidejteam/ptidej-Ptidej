...
public class Aggregation_CLASS_CLASS_FROM_FIELD_1 extends TestCase {
				...
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
								...
								"../PADL Analyses Tests/bin/padl/analysis/aac/data/Aggregation_CLASS_CLASS_FROM_FIELD_1.class" }));
