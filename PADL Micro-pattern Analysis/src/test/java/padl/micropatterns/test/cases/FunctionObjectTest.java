 ...
 * @author tanterij
 */
public class FunctionObjectTest extends TestCase {

	private static MicroPatternDetector detector;
	private MicroPatternDetector currentDetector;

	public FunctionObjectTest(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (FunctionObjectTest.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/FunctionObject.class", }));
			}
