 ...
 * @author tanterij
 */
public class TestCanopy extends TestCase {

	private static MicroPatternDetector detector;
	private MicroPatternDetector currentDetector;

	public TestCanopy(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestCanopy.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Canopy.class", }));
			}
			catch (Exception e) {
	...
	public void testCanopy() {
		Assert.assertEquals("Box", 1, this.currentDetector.getNumberOfCanopy());
	}
}
