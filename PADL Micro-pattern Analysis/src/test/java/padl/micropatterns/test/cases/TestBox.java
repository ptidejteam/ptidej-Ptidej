...
public class TestBox extends TestCase {
	...
	public TestBox(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestBox.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Box.class", }));
			}
			catch (Exception e) {
	...
	public void testBox() {
		Assert.assertEquals("Box", 1, this.currentDetector.getNumberOfBox());
	}
}
