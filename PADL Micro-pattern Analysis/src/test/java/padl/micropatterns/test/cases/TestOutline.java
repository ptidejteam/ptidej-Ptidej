 ...
 * @author tanterij
 */
public class TestOutline extends TestCase {

	private static MicroPatternDetector detector;
	private MicroPatternDetector currentDetector;

	public TestOutline(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestOutline.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Outline.class", }));
			}
			catch (Exception e) {
	...
	public void testOutline() {
		Assert.assertEquals(
			"Outline",
			1,
			this.currentDetector.getNumberOfOutLine());
	}
}
