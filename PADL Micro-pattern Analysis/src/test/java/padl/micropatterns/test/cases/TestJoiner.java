...
public class TestJoiner extends TestCase {
	...
	public TestJoiner(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestJoiner.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
								"../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/IJoiner1.class",
								"../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/IJoiner2.class",
								"../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/IJoiner3.class", }));
			}
	...
	public void testJoiner() {
		Assert.assertEquals(
			"Joiner",
			1,
			this.currentDetector.getNumberOfJoiner());
	}
}
