...
public class TestStateless extends TestCase {
	...
	public TestStateless(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestStateless.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Stateless.class", }));
			}
	...
	public void testStateless() {
		Assert.assertEquals(
			"Stateless  ",
			1,
			this.currentDetector.getNumberOfStateless());
	}
}
