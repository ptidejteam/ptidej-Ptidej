 ...
 * @author tanterij
 */
public class TestTrait extends TestCase {

	private static MicroPatternDetector detector;
	private MicroPatternDetector currentDetector;

	public TestTrait(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestTrait.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Trait.class", }));
			}
	...
	public void testTrait() {
		Assert
			.assertEquals("Trait", 1, this.currentDetector.getNumberOfTrait());
	}
}
