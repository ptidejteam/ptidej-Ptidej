...
public class TestRecord extends TestCase {
	...
	public TestRecord(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (TestRecord.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] { "../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Record.class", }));
			}
			catch (Exception e) {
	...
	public void testRecord() {
		Assert.assertEquals(
			"Record",
			1,
			this.currentDetector.getNumberOfRecord());
	}
}
