...
public class ImplementorTest extends TestCase {
	...
	public ImplementorTest(String arg0) {
		super(arg0);
	}

	protected void setUp() {

		if (ImplementorTest.detector == null) {
			...
			try {
				codeLevelModel
					.create(new CompleteClassFileCreator(
						new String[] {
								"../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/Implementor.class",
								"../PADL Micro-pattern Analysis/target/test-classes/padl/micropatterns/examples/ImplementorBase.class", }));
			}
