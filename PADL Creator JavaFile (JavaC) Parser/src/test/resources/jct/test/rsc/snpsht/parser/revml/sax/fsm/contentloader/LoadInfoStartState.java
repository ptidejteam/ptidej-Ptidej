...
public class LoadInfoStartState
...
{
this.getFsm().changeState(new jct.test.rsc.snpsht.parser.revml.sax.fsm.contentloader.LoadInfoRevisionsScanState(this.getFsm(), this, this.getManager()));
...
{
java.lang.String toRet = "<LoadInfoStartState>";
return toRet;
