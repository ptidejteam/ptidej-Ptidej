...
{
if(jct.test.rsc.jct.kernel.JCTKind.CLASS == aKind) 
{
return new jct.test.rsc.jct.util.ListOfElements(this.getAllEnclosedElements(jct.test.rsc.jct.kernel.JCTKind.CLASS, class, true));

}
return this.seeNextPathStep(aKind);
