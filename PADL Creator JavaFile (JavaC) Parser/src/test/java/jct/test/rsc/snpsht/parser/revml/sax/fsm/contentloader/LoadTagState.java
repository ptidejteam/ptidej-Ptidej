...
public class LoadTagState extends AbstractStringLoaderState {
	...
	protected void processString(String loadedString) {
		getManager().addTag(loadedString, getFile());
	}

	@Override
	public String toString() {
		String toRet = "<LoadTagState>\nTag: " + getLoadedString();
		return toRet;
	}

	@Override
	protected String getWaitedMarker() {
		return RevMLDocCommonsStrings.FILE_REV_TAG_MARKER;
	}
