...
public class LoadRevIDState extends AbstractStringLoaderState {

	public LoadRevIDState(
	...
	protected void processString(String loadedString) {
		getManager().setRevID(loadedString, getFile());
	}
	...
	protected String getWaitedMarker() {
		return RevMLDocCommonsStrings.FILE_REV_REV_ID_MARKER;
	}
