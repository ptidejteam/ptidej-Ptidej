...
public class LoadActionState extends AbstractStringLoaderState {

	public LoadActionState(
	...
	protected void processString(String loadedString) {
		getManager().setAction(loadedString, getFile());
	}

	@Override
	public String toString() {
		String toRet = "<LoadActionState>\nAction: " + getLoadedString();
		return toRet;
	}

	@Override
	protected String getWaitedMarker() {
		return RevMLDocCommonsStrings.FILE_REV_ACTION_MARKER;
	}
