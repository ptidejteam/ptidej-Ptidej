...
public class SnapshotDiff<T> {
	...
	public SnapshotDiff(Set<T> addedElements, Set<T> removedElements) {
	...
	public boolean isDiff() {
		...
		// diff.addAll(this.addedElements);
		// diff.removeAll(this.removedElements);
		// return (diff.size() != 0);
