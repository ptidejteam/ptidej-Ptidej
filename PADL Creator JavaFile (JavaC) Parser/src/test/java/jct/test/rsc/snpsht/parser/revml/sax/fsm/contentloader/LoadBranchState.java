...
public class LoadBranchState extends AbstractStringLoaderState {

	public LoadBranchState(
	...
	protected void processString(String loadedString) {
		getManager().setBranch(loadedString, getFile());
	}

	@Override
	public String toString() {
		String toRet = "<LoadBranchState>\nBranch: " + getLoadedString();
		return toRet;
	}

	@Override
	protected String getWaitedMarker() {
		return RevMLDocCommonsStrings.FILE_REV_BRANCH_MARKER;
	}
