...
public class MainSingleBranchPrioSnapshooter extends
		AbstractMainBranchPrioSnapshooter {

	public MainSingleBranchPrioSnapshooter(VerFsManager manager) {
		super(manager);
	}

	public MainSingleBranchPrioSnapshooter(
