...
public abstract class AbstractVerFsVisitor implements IVerFsVisitor {

	@Override
	public Object visit(IVerFsElement toVisit) {
		try {
			return visit((IVerFsComplexElement) toVisit);
		} catch (ClassCastException e1) {
			try {
				return visit((IVerFsSimpleRevision) toVisit);
	...
	public abstract Object visit(IVerFsComplexElement toVisit);
	public abstract Object visit(IVerFsSimpleRevision toVisit);
}
