...
public abstract class AttributeFigure extends AbstractFigure {
	...
	private static void initializeAttributes() {
		...
		fgDefaultAttributes.set("ArrowMode",  Integer.valueOf(0));
		fgDefaultAttributes.set("FontName",  "Helvetica");
		fgDefaultAttributes.set("FontSize",   Integer.valueOf(12));
		fgDefaultAttributes.set("FontStyle",  Integer.valueOf(Font.PLAIN));
	}
