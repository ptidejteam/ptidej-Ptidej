	...
	protected void createAttributeChoices(Panel panel) {
		...
		choice.addItem(
			new ChangeAttributeCommand(
				"none",
				"ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_NONE),
				fView));
		choice.addItem(
			new ChangeAttributeCommand(
				"at Start",
				"ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_START),
				fView));
		choice.addItem(
			new ChangeAttributeCommand(
				"at End",
				"ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_END),
				fView));
		choice.addItem(
			new ChangeAttributeCommand(
				"at Both",
				"ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_BOTH),
				fView));
