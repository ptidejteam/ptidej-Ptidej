...
public class DrawApplication extends Frame implements DrawingEditor,
	...
	protected Menu createArrowMenu() {
		...
		menu.add(new ChangeAttributeCommand("none", "ArrowMode", Integer.valueOf(
				PolyLineFigure.ARROW_TIP_NONE), fView));
		menu.add(new ChangeAttributeCommand("at Start", "ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_START), fView));
		menu.add(new ChangeAttributeCommand("at End", "ArrowMode", Integer.valueOf(
				PolyLineFigure.ARROW_TIP_END), fView));
		menu.add(new ChangeAttributeCommand("at Both", "ArrowMode",
				Integer.valueOf(PolyLineFigure.ARROW_TIP_BOTH), fView));
		return menu;
	}
	...
	protected Menu createFontStyleMenu() {
		...
		menu.add(new ChangeAttributeCommand("Plain", "FontStyle", Integer.valueOf(
				Font.PLAIN), fView));
		menu.add(new ChangeAttributeCommand("Italic", "FontStyle", Integer.valueOf(
				Font.ITALIC), fView));
		menu.add(new ChangeAttributeCommand("Bold", "FontStyle", Integer.valueOf(
				Font.BOLD), fView));
		return menu;
	}
	...
	protected Menu createFontSizeMenu() {
		...
		for (int i = 0; i < sizes.length; i++) {
			menu.add(new ChangeAttributeCommand(Integer.toString(sizes[i]),
					"FontSize", Integer.valueOf(sizes[i]), fView));
		}
		return menu;
	}
