...
public class WrapperClient {
    ...
    public void parse(final NamedReader[] javaSourceList, final ASTVisitor[] visitors) {
        for (final NamedReader javaFilePath : javaSourceList) {
            this.parseAJavaSource(javaFilePath, visitors);
        }
    }

    private void parseAJavaSource(final NamedReader javaSourcePath, final ASTVisitor[] visitors) {
