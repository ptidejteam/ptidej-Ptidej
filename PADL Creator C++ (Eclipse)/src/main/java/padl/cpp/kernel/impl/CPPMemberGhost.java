...
import padl.kernel.impl.MemberGhost;

public class CPPMemberGhost extends MemberGhost implements ICPPMemberGhost {
	...
	public CPPMemberGhost(final char[] anID, final char[] aName) {
		super(anID, aName);
	}
