...
public class ParseException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7126074391742996280L;
	...
	public String getMessage() {
		...
		for (int i = 0; i < this.expectedTokenSequences.length; i++) {
			...
			for (int j = 0; j < this.expectedTokenSequences[i].length; j++) {
				expected +=
					this.tokenImage[this.expectedTokenSequences[i][j]] + " ";
			}
		...
		retval +=
			"\" at line " + this.currentToken.next.beginLine + ", column "
