...
public class Csegment2Test extends CppPrimitive {
	...
	protected void setUp() {
		...
		if (Csegment2Test.FirstClassEntities == null
			...
			final ICodeLevelModel codeLevelModel = CppPrimitive.getFactory()
					.createCodeLevelModel("csegment2.cpp");
			try {
				codeLevelModel.create(new CPPCreator(new String[] {
						"../PADL Creator C++ (JavaCC)/target/test-classes/csegment2.cpp" }));
			}
			catch (final CreationException e) {
				e.printStackTrace();
			}

			Csegment2Test.FirstClassEntities = Util
					.getArrayOfTopLevelEntities(codeLevelModel);

			// All the element of the first class
			Csegment2Test.Elements = Util
					.getArrayOfElements(Csegment2Test.FirstClassEntities[1]);
		}
	}

	public void testClass() {
		//---------------------------------------
		Assert.assertEquals("Class name", "CSegment",
				((IClass) Csegment2Test.FirstClassEntities[1])
						.getDisplayName());
	...
	public void testGhost() {
		//---------------------------------------
		Assert.assertEquals("Ghost name", "CPoint",
				((IGhost) Csegment2Test.FirstClassEntities[0])
						.getDisplayName());

		Assert.assertEquals("Ghost type", Access.ACC_PUBLIC,
	...
	public void testClassCsegmentConstructor() {
		//---------------------------------------
		Assert.assertEquals("Constr Name", "CSegment",
		...
		final int num1 = ((IConstructor) Csegment2Test.Elements[0])
		...
		final int num2 = ((IConstructor) Csegment2Test.Elements[1])
				.getNumberOfConstituents();
	...
	public void testClassCpointMethod() {
		//---------------------------------------
		Assert.assertEquals("Method Name", "afficher",
		...
		Assert.assertEquals("Method # Parameters", 0,
				((IMethod) Csegment2Test.Elements[2])
						.getNumberOfConstituents());

		//---------------------------------------
		Assert.assertEquals("Method Name", "calculer_longueur",
				Csegment2Test.Elements[3].getDisplayName());

		Assert.assertEquals("Method Return Type", "double",
		...
		Assert.assertEquals("Method # Parameters", 0,
				((IMethod) Csegment2Test.Elements[3])
						.getNumberOfConstituents());

		//---------------------------------------
		Assert.assertEquals("Method Name", "dephasage",
		...
		Assert.assertEquals("Method # Parameters", 1,
				((IMethod) Csegment2Test.Elements[4])
						.getNumberOfConstituents());

		//---------------------------------------
		Assert.assertEquals("Method Name", "ecrire",
				Csegment2Test.Elements[5].getDisplayName());
		...
		Assert.assertEquals("Method # Parameters", 2,
				((IMethod) Csegment2Test.Elements[5])
						.getNumberOfConstituents());

		//---------------------------------------
		Assert.assertEquals("Method Name", "getp1",
				Csegment2Test.Elements[6].getDisplayName());

		Assert.assertEquals("Method Return Type", "CPoint",
		...
		Assert.assertEquals("Method # Parameters", 0,
				((IMethod) Csegment2Test.Elements[6])
						.getNumberOfConstituents());

		//---------------------------------------
		Assert.assertEquals("Method Name", "getp2",
				Csegment2Test.Elements[7].getDisplayName());
		...
		Assert.assertEquals("Method # Parameters", 0,
				((IMethod) Csegment2Test.Elements[7])
						.getNumberOfConstituents());
	...
	public void testClassCpointField() {
		...
		//---------------------------------------
		Assert.assertEquals("Field Name", "m_point1",
				Csegment2Test.Elements[8].getDisplayName());

		Assert.assertEquals("Field Type", "CPoint",
				((IField) Csegment2Test.Elements[8]).getDisplayTypeName());

		Assert.assertEquals("Field Access", Access.ACC_PRIVATE,
				((IField) Csegment2Test.Elements[8]).getVisibility());

		//---------------------------------------
		Assert.assertEquals("Field Name", "m_point2",
				Csegment2Test.Elements[9].getDisplayName());
	...
	public void testClassCpointRelationship() {
		Assert.assertEquals("Relationship target name", "CPoint",
