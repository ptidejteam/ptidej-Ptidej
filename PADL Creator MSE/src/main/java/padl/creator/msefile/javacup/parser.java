...
class CUP$parser$actions {
	...
	protected void add_precedence(final String term) {
		if (term == null) {
			...
			if (sp == null) {
				...
				final padl.creator.msefile.javacup.symbol sym = sp.the_symbol();
	...
	public final padl.creator.msefile.javacup.runtime.Symbol CUP$parser$do_action(
		final int CUP$parser$act_num,
		final padl.creator.msefile.javacup.runtime.lr_parser CUP$parser$parser,
		final java.util.Stack CUP$parser$stack,
		final int CUP$parser$top) throws java.lang.Exception {
		/* Symbol object for return from actions */
		padl.creator.msefile.javacup.runtime.Symbol CUP$parser$result;
			...
			case 106 : // empty ::= 
				{
					...
					CUP$parser$result =
						new padl.creator.msefile.javacup.runtime.Symbol(
							29/*empty*/,
							((padl.creator.msefile.javacup.runtime.Symbol) CUP$parser$stack
			...
			case 86 : // robust_id ::= ID 
				{
					String RESULT = null;
					final String the_id =
						(String) ((padl.creator.msefile.javacup.runtime.Symbol) CUP$parser$stack
			...
			case 65 : // rhs ::= prod_part_list PERCENT_PREC term_id 
				{
					...
					padl.creator.msefile.javacup.symbol sym = null;
					if (this.lhs_nt != null) {
			...
			case 62 : // production ::= error NT$13 SEMI 
				{
					...
					if (((padl.creator.msefile.javacup.runtime.Symbol) CUP$parser$stack
						.elementAt(CUP$parser$top - 1)).value != null) {
						RESULT =
							(Object) ((padl.creator.msefile.javacup.runtime.Symbol) CUP$parser$stack
								.elementAt(CUP$parser$top - 1)).value;
					}
...
/** CUP v0.10k generated parser.
  ...
  */
public class parser extends padl.creator.msefile.javacup.runtime.lr_parser {
	...
	public parser(final padl.creator.msefile.javacup.runtime.Scanner s) {
		super(s);
	}
	...
	public padl.creator.msefile.javacup.runtime.Symbol scan()
			throws java.lang.Exception {
